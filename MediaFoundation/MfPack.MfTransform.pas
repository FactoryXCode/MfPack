...
{$WARN BOUNDS_ERROR ON}
  ...
  _MFT_SET_TYPE_FLAGS = (
    ...
    // Carried over from DMO (IMediaObject)
    //
    MFT_SET_TYPE_TEST_ONLY	= $00000001, // check but don't set

    //
    // not carried over from DMO - use Nil type to unset.
    //
    MFT_SET_TYPE_CLEAR      = $00000002 // unset
  );
  ...
  _MFT_PROCESS_OUTPUT_FLAGS = (
    MFT_PROCESS_OUTPUT_DISCARD_WHEN_NO_BUFFER	= $1, // discard this sample if pSample ptr is Nil.
    MFT_PROCESS_OUTPUT_REGENERATE_LAST_OUTPUT = $2  // New flags for MFTs
  );
  ...
  _MFT_PROCESS_OUTPUT_STATUS = (
    MFT_PROCESS_OUTPUT_STATUS_NEW_STREAMS	= $100  // Output flag
  );
