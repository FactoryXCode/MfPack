...
// Module: MfPack.MfSharingEngine.pas
...
type
  ...
  MF_SHARING_ENGINE_EVENT                         = (
    ...
    {$EXTERNALSYM MF_SHARING_ENGINE_EVENT_DISCONNECT}
    MF_SHARING_ENGINE_EVENT_LOCALRENDERINGSTARTED = 2001,
    {$EXTERNALSYM MF_SHARING_ENGINE_EVENT_LOCALRENDERINGSTARTED}
    MF_SHARING_ENGINE_EVENT_LOCALRENDERINGENDED   = 2002,
    {$EXTERNALSYM MF_SHARING_ENGINE_EVENT_LOCALRENDERINGENDED}
    MF_SHARING_ENGINE_EVENT_STOPPED               = 2003,
    {$EXTERNALSYM MF_SHARING_ENGINE_EVENT_STOPPED}
    MF_SHARING_ENGINE_EVENT_ERROR                 = 2501
    {$EXTERNALSYM MF_SHARING_ENGINE_EVENT_ERROR}
  );
  ...
  MF_MEDIA_SHARING_ENGINE_EVENT              = (
    ...
    {$EXTERNALSYM MF_MEDIA_SHARING_ENGINE_EVENT_DISCONNECT}
  );
