...
type
  ...
  AM_DVD_ChangeRate = record
     StartInTime  : REFERENCE_TIME;  // stream time (input) at which to start decoding at this rate
     StartOutTime : REFERENCE_TIME;  // reference time (output) at which to start showing at this rate
     Rate         : LongInt;         // new rate * 10000 (decimal)
  end;
