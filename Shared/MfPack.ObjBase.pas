...
type
  ...
  function CoLoadLibrary(pszLibName: POlESTR;
  ...
  function CoIsOle1Class(const clsid: CLSID): BOOL; stdcall;
  ...
  function CoRegisterChannelHook(const ExtensionUuid: REFGUID;
  ...
  function CoTreatAsClass(const clsidOld: REFCLSID;
                          out clsidNew: REFCLSID): HResult; stdcall;
  ...
  function StgOpenLayoutDocfile(pwcsDfName: POLESTR;
                                grfMode: DWORD;
                                reserved: DWORD;
                                var ppstgOpen: IStorage): HResult; stdcall;
  ...
  function CoGetObject(lpszName: LPCWSTR;
  ...
  function GetClassFile(szFilename: POLESTR;
                        out clsid: CLSID): HResult; stdcall;
  {$EXTERNALSYM GetClassFile}

  function CreateFileMoniker(lpszPathName: POLESTR;
                             out ppmk: IMoniker): HResult; stdcall;
  {$EXTERNALSYM CreateFileMoniker}

  function CreateClassMoniker(const rclsid: REFCLSID;
                             out ppmk: IMoniker): HResult; stdcall;
  {$EXTERNALSYM CreateClassMoniker}

  function CreateItemMoniker(lpszDelim: POLESTR;
                             lpszItem: POLESTR;
                             out ppmk: IMoniker): HResult; stdcall;
