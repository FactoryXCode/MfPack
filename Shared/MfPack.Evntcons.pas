...
//#if (WINVER >= _WIN32_WINNT_LONGHORN)
  ...
  function EventAccessControl(const Guid: LPGUID;
                              Operation: ULONG;
                              Sid: PSID;
                              Rights: ULONG;
  ...
  function EventAccessQuery(const Guid: LPGUID;
                            out Buffer: PSECURITY_DESCRIPTOR;
                            var BufferSize: PULONG): ULONG; stdcall;
  {$EXTERNALSYM EventAccessQuery}

  function EventAccessRemove(const Guid: LPGUID): ULONG; stdcall;
