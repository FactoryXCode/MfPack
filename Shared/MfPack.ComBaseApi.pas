...
type
  ...
  function CoAllowUnmarshalerCLSID(const clsid: REFCLSID): HResult; stdcall;
  {$EXTERNALSYM CoAllowUnmarshalerCLSID}

  function CoGetObjectContext(const riid: REFIID;
                              out ppv): HResult; stdcall;
  {$EXTERNALSYM CoGetObjectContext}

  //* register/revoke/get class objects */

  function CoGetClassObject(const rclsid: REFCLSID;
                            dwClsContext: DWORD;
                            pvReserved: Pointer;
                            const riid: REFIID;
                            out ppv): HResult; stdcall;
  ...
  function CoRegisterClassObject(const rclsid: REFCLSID;
                                 pUnk: PUNKNOWN;
                                 dwClsContext: DWORD;
                                 flags: DWORD;
  ...
  function CoGetPSClsid(const riid: REFIID;
                        out pClsid: CLSID): HResult; stdcall;
  {$EXTERNALSYM CoGetPSClsid}

  function CoRegisterPSClsid(const riid: REFIID;
                             const rclsid: REFCLSID): HResult; stdcall;
  ...
  function CoGetStandardMarshal(const iid: IID;
...
type
  ...
  function CoMarshalInterThreadInterfaceInStream(const riid: IID;
                                                 pUnk: IUnknown;
  ...
  function CoGetCallContext(const riid: IID;
...
const
  ...
  function CoCreateInstance(const rclsid: CLSID;
                            unkOuter: IUnknown;
  ...
  function CoCreateInstanceEx(const Clsid: CLSID;
                              punkOuter: IUnknown;
                              dwClsCtx: Longint;
  ...
  function CoCreateInstanceFromApp(const Clsid: REFCLSID;
                                   punkOuter: IUnknown;
                                   dwClsCtx: DWORD;
                                   reserved: Pointer;
                                   dwCount: DWORD;
  ...
  function StringFromCLSID(const clsid: CLSID;
  ...
  function PropVariantCopy(out pvarDest: MfPROPVARIANT;
                           const pvarSrc: MfPROPVARIANT): HResult; stdcall;
  {$EXTERNALSYM PropVariantCopy}

  function PropVariantClear(var pvar: MfPROPVARIANT): HResult; stdcall;
  {$EXTERNALSYM PropVariantClear}

  function FreePropVariantArray(cVariants: ULONG;
                                rgvars: PMfPROPVARIANT): HResult; stdcall;
  {$EXTERNALSYM FreePropVariantArray}

  // NOTE: This function is also declared in PropVarUtil.pas!
  procedure PropVariantInit(var pvar: MfPROPVARIANT); inline;
  ...
  function CoWaitForMultipleHandles(dwFlags: DWORD;
                                    dwTimeout: DWORD;
                                    cHandles: ULONG;
                                    pHandles: LPHANDLE;     // array of handles
...
const
  ...
  function CoGetTreatAsClass(const clsidOld: CLSID;
                             out clsidNew: CLSID): HResult; stdcall;
  {$EXTERNALSYM CoGetTreatAsClass}

  function CoTreatAsClass(const clsidOld: CLSID;
                          const clsidNew: CLSID): HResult; stdcall;
  ...
  function CoInvalidateRemoteMachineBindings(pszMachineName: LPOLESTR): HResult; stdcall;
...
type
  ...
  function CLSIDFromProgIDEx(lpszProgID: LPCOLESTR;
                             out lpclsid: LPCLSID): HResult; stdcall;
