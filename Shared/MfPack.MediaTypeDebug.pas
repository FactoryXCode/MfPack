...
// Module: Media Foundation - MfMediaTypeDebug.pas
// Kind: Pascal Unit
...
// 15/09/2019                     Renamed the unit MfMethods to MfMetLib.pas and added more helpers.
//                                Underworld release.
//------------------------------------------------------------------------------
//
// Remarks:
//
// Related objects: MfPack Samples >= 2.6.2
...
function LogVideoArea(pvar: mfPROPVARIANT): HRESULT;
var
  pArea: PMFVideoArea;
...
procedure LogUINT32AsUINT64(pvar: mfPROPVARIANT);
var
  uHigh: UINT32;
  uLow:  UINT32;
