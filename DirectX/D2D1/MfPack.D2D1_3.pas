...
type
  ...
  ['{2e69f9e8-dd3f-4bf9-95ba-c04f49d788df}']
    ...
    function GetDpi(out dpiX: FLOAT;
                    out dpiY: FLOAT): HResult; stdcall;
...
//#if NTDDI_VERSION >= NTDDI_WIN10_RS1
  ...
  ['{af671749-d241-4db8-8e41-dcc2e5c1a438}']
    ...
    function SetStroke({in_opt} brush: ID2D1Brush;
                       ...
                       dashOffset: FLOAT = 1.0): HResult; stdcall;
    ...
    procedure GetStroke(out brush: ID2D1Brush;
                        {out} strokeWidth: FLOAT = 0.0;
                        {out} dashes: FLOAT = 0.0;
                        dashesCount: UINT32 = 0;
                        {out} dashOffset: FLOAT = 0.0); stdcall;
