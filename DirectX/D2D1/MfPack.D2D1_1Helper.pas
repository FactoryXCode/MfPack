...
// Module: MfPack.D2D1_1Helper.pas
...
function Vector2F(x: FLOAT = 0.0;
                  y: FLOAT = 0.0): D2D1_VECTOR_2F;
{$EXTERNALSYM Vector2F}

function Vector3F(x: FLOAT = 0.0;
                  y: FLOAT = 0.0;
                  z: FLOAT = 0.0): D2D1_VECTOR_3F;
{$EXTERNALSYM Vector3F}

function Vector4F(x: FLOAT = 0.0;
                  y: FLOAT = 0.0;
                  z: FLOAT = 0.0;
                  w: FLOAT = 0.0): D2D1_VECTOR_4F;
