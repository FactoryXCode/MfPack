...
type
  ...
  ['{fc51a552-d5e7-11d9-af55-00054e43ff02}']
    ...
    function GetVideoProcessorRenderTargets(const VideoProcDeviceGuid: REFGUID;
                                            pVideoDesc: DXVA2_VideoDesc;
                                            out pCount: UINT;
                                            out pFormats: PD3DFORMAT): HResult; stdcall;

    function GetVideoProcessorSubStreamFormats(const VideoProcDeviceGuid: REFGUID;
                                               pVideoDesc: DXVA2_VideoDesc;
                                               RenderTargetFormat: D3DFORMAT;
                                               out pCount: UINT;
                                               out pFormats: PD3DFORMAT): HResult; stdcall;

    function GetVideoProcessorCaps(const VideoProcDeviceGuid: REFGUID;
                                   pVideoDesc: DXVA2_VideoDesc;
                                   RenderTargetFormat: D3DFORMAT;
                                   out pCaps: DXVA2_VideoProcessorCaps): HResult; stdcall;

    function GetProcAmpRange(const VideoProcDeviceGuid: REFGUID;
                             pVideoDesc: DXVA2_VideoDesc;
                             RenderTargetFormat: D3DFORMAT;
                             ProcAmpCap: UINT;
                             out pRange: DXVA2_ValueRange): HResult; stdcall;

    function GetFilterPropertyRange(const VideoProcDeviceGuid: REFGUID;
                                    pVideoDesc: DXVA2_VideoDesc;
                                    RenderTargetFormat: D3DFORMAT;
                                    FilterSetting: UINT;
                                    out pRange: DXVA2_ValueRange): HResult; stdcall;

    function CreateVideoProcessor(const VideoProcDeviceGuid: REFGUID;
                                  pVideoDesc: DXVA2_VideoDesc;
                                  RenderTargetFormat: D3DFORMAT;
  ...
  //  see:
  function DXVA2FloatToFixed(_float_: FLOAT): DXVA2_Fixed32; inline;
