...
type
  ...
  FXEQ_PARAMETERS = record
    FrequencyCenter0: FLOAT;        // center frequency in Hz, band 0
    Gain0: FLOAT;                   // boost/cut
    Bandwidth0: FLOAT;              // bandwidth, region of EQ is center frequency +/- bandwidth/2
    FrequencyCenter1: FLOAT;        // band 1
    Gain1: FLOAT;
    Bandwidth1: FLOAT;
    FrequencyCenter2: FLOAT;        // band 2
    Gain2: FLOAT;
    Bandwidth2: FLOAT;
    FrequencyCenter3: FLOAT;        // band 3
    Gain3: FLOAT;
    Bandwidth3: FLOAT;
  end;
  ...
  function CreateFX(clsid: REFCLSID;
