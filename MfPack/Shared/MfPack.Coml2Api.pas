...
const
  ...
  function StgSetTimes(pszName: POLESTR;
                       ...
                       const mtime: FILETIME): HResult; inline; overload;
  {$EXTERNALSYM StgSetTimes}

  function StgSetTimes(pszName: POLESTR;
                       ctime: PFILETIME;
                       atime: PFILETIME;
                       mtime: PFILETIME): HResult; overload; stdcall;
  {$EXTERNALSYM StgSetTimes}
...
const
  ...
  function FmtIdToPropStgName(const pfmtid: FMTID;
  ...
  function WriteClassStg(pstg: IStorage;
                         const rclsid: IID): HResult; stdcall;
  ...
  function WriteClassStm(pstm: IStream;
                         const pclsid: IID): HResult; stdcall;
...
function StgSetTimes(pszName: POLESTR;
                     const ctime: FILETIME;
                     const atime: FILETIME;
                     const mtime: FILETIME): HResult; inline;
begin
  Result := StgSetTimes(pszName,
                        @ctime,
                        @atime,
                        @mtime);
end;
