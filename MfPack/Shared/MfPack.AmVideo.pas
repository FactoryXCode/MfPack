...
// DirectShow will be slowly phased out, so for now it's defined in MfpTypes.pas
// Note: Also used in MF-core audio.
...
type
  ...
  IFullScreenVideo = interface(IUnknown)
    ...
    function SetCaption(const strCaption: BSTR): HResult; stdcall;
