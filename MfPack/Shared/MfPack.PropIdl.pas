...
type
  ...
  tagPROPVARIANT = record
    ...
    case Integer of
      ...
      VT_BYREF OR VT_VARIANT:     (pvarVal: PMfPROPVARIANT); // = PPROPVARIANT
  end;
...
type
  ...
  ['{00000138-0000-0000-C000-000000000046}']
    function ReadMultiple(cpspec: ULONG;
                          rgpspec: PROPSPEC;
                          out rgpropvar: MfPROPVARIANT): HResult; stdcall;

    function WriteMultiple(cpspec: ULONG;
                           rgpspec: PROPSPEC;
                           rgpropvar: MfPROPVARIANT;
  ...
  function PropVariantCopy(var pvarDest: MfPROPVARIANT;
                           var pvarSrc: MfPROPVARIANT): HResult; stdcall;
  ...
  function StgConvertVariantToProperty(pvar: MfPROPVARIANT;
                                       CodePage: USHORT;
  ...
  // Forward functions
  procedure PropVariantInit(var pv: MfPROPVARIANT);
...
const
  ...
  procedure PropVariantInit(var pv: MfPROPVARIANT);
    begin
      FillChar(pv, sizeof(MfPROPVARIANT), 0);
    end;
