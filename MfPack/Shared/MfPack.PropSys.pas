...
uses
  ...
  MfPack.StructuredQueryCondition;
...
type
  ...
  {$EXTERNALSYM IPropertyStore}
   ...
   ['{886d8eeb-8cf2-4446-8d02-cdba1dbdcf99}']
     ...
     function GetValue(key: PROPERTYKEY;
                       out pv: MfPROPVARIANT): HResult; stdcall;

     function SetValue(key: PROPERTYKEY;
                       propvar: MfPROPVARIANT): HResult; stdcall;
  ...
  ['{f917bc8a-1bba-4478-a245-1bde03eb9431}']
    ...
    function ApplyToPropVariant(propvarIn: REFPROPVARIANT;
                                out ppropvarOut: MfPROPVARIANT): HResult; stdcall;
  ...
  ['{11e1fbf9-2d56-4a6b-8db3-7cd193a471f2}']
    ...
    function GetValue(out ppropvar: MfPROPVARIANT): HResult; stdcall;

    function GetRangeMinValue(out ppropvarMin: MfPROPVARIANT): HResult; stdcall;

    function GetRangeSetValue(out ppropvarSet: MfPROPVARIANT): HResult; stdcall;
  ...
  ['{6f79d558-3e96-4549-a1d1-7d75d2288814}']
    ...
    function CoerceToCanonicalValue(var ppropvar: MfPROPVARIANT): HResult; stdcall;
