...
uses
  ...
  MfPack.ObjIdl,     // ActiveX
  MfPack.OcIdl,      // ActiveX
  MfPack.PropIdl;
...
{$WARN BOUNDS_ERROR ON}
  ...
  ['{9204FE99-D8FC-4FD5-A001-9536B067A899}']
    ...
    function GetValueByIndex(nIndex: UINT;
                             var pvarSchema: mfPROPVARIANT;
                             var pvarId: mfPROPVARIANT;
                             var pvarValue: mfPROPVARIANT): HResult; stdcall;

    function GetValue(const pvarSchema: mfPROPVARIANT;
                      const pvarId: mfPROPVARIANT;
                      var pvarValue: mfPROPVARIANT): HResult; stdcall;
  ...
  ['{F7836E16-3BE0-470B-86BB-160D0AECD7DE}']
    function SetValue(const pvarSchema: mfPROPVARIANT;
                      const pvarId: mfPROPVARIANT;
                      const pvarValue: mfPROPVARIANT): HResult; stdcall;

    function SetValueByIndex(const pvarSchema: mfPROPVARIANT;
                             const pvarId: mfPROPVARIANT;
                             const pvarValue: mfPROPVARIANT): HResult; stdcall;

    function RemoveValue(const pvarSchema: mfPROPVARIANT;
                         const pvarId: mfPROPVARIANT): HResult; stdcall;
  ...
  ['{EEBF1F5B-07C1-4447-A3AB-22ACAF78A804}']
    function GetPatterns(guidContainerFormat: REFGUID;
                         cbSize: UINT;
                         var  pPattern: PWICMetadataPattern;
                         out pcCount: UINT;
                         out pcbActual: UINT): HResult; stdcall;

    function MatchesPattern(guidContainerFormat: REFGUID;
                            pIStream: IStream;
  ...
  ['{B22E3FBA-3925-4323-B5C1-9EBFC430F236}']
    function GetHeader(const guidContainerFormat: REFGUID;
                       cbSize: UINT;
  ...
  ['{412D0C3A-9650-44FA-AF5B-DD2A06C8E8FB}']
    function CreateMetadataReader(const guidMetadataFormat: REFGUID;
                                  const pguidVendor: TGuid;
                                  dwOptions: DWORD;
                                  pIStream: IStream;
                                  out ppIReader: IWICMetadataReader): HResult; stdcall;

    function CreateMetadataReaderFromContainer(const guidContainerFormat: REFGUID;
                                               const pguidVendor: TGuid;
                                               dwOptions: DWORD;
                                               pIStream: IStream;
                                               out ppIReader: IWICMetadataReader): HResult; stdcall;

    function CreateMetadataWriter(const guidMetadataFormat: REFGUID;
                                  const pguidVendor: TGuid;
  ...
  function WICMatchMetadataContent(const guidContainerFormat: REFGUID;
                                   const pguidVendor: TGuid;
                                   pIStream: IStream;
                                   out pguidMetadataFormat: TGuid): HResult; stdcall;
  {$EXTERNALSYM WICMatchMetadataContent}

  function WICSerializeMetadataContent(const guidContainerFormat: REFGUID;
                                       pIWriter: IWICMetadataWriter;
                                       dwPersistOptions: DWORD;
                                       pIStream: IStream): HResult; stdcall;
  {$EXTERNALSYM WICSerializeMetadataContent}

  function WICGetMetadataContentSize(const guidContainerFormat: REFGUID;
                                     pIWriter: IWICMetadataWriter;
