...
function InitPropVariantFromPropVariantVectorElem(propvarIn: MfPROPVARIANT;
                                                  iElem: ULONG;
                                                  out ppropvar: MfPROPVARIANT): HResult; stdcall;
{$EXTERNALSYM InitPropVariantFromPropVariantVectorElem}

function InitPropVariantVectorFromPropVariant(propvarSingle: MfPROPVARIANT;
                                              out ppropvarVector: MfPROPVARIANT): HResult; stdcall;
...
function IsPropVariantVector(const propvar: MfPROPVARIANT): BOOL; inline;
...
function PropVariantGetElementCount(const vpropvar: MfPROPVARIANT): ULONG; stdcall;
{$EXTERNALSYM PropVariantGetElementCount}

// Extract data from a propvariant into a vector
function PropVariantToBooleanVector(const propvar: PMfPROPVARIANT;
                                    out prgf: BOOL;
                                    crgf: ULONG;
                                    out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToBooleanVector}

function PropVariantToInt16Vector(const propvar: MfPROPVARIANT;
                                  out prgn: SHORT;
                                  crgn: ULONG;
                                  out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToInt16Vector}

function PropVariantToUInt16Vector(const propvar: MfPROPVARIANT;
                                   out prgn: USHORT;
                                   crgn: ULONG;
                                   out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToUInt16Vector}

function PropVariantToInt32Vector(const propvar: MfPROPVARIANT;
                                  out prgn: LONG;
                                  crgn: ULONG;
                                  out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToInt32Vector}

function PropVariantToUInt32Vector(const propvar: MfPROPVARIANT;
                                   out prgn: ULONG;
                                   crgn: ULONG;
                                   out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToUInt32Vector}

function PropVariantToInt64Vector(const propvar: MfPROPVARIANT;
                                  out prgn: LONGLONG;
                                  crgn: ULONG;
                                  out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToInt64Vector}

function PropVariantToUInt64Vector(const propvar: MfPROPVARIANT;
                                   out prgn: ULONGLONG;
                                   crgn: ULONG;
                                   out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToUInt64Vector}

function PropVariantToDoubleVector(const propvar: MfPROPVARIANT;
                                   out prgn: DOUBLE;
                                   crgn: ULONG;
                                   out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToDoubleVector}

function PropVariantToFileTimeVector(const propvar: MfPROPVARIANT;
                                     out prgft: FILETIME;
                                     crgft: ULONG;
                                     out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToFileTimeVector}

function PropVariantToStringVector(const propvar: MfPROPVARIANT;
                                   out prgsz: LPCWSTR;
                                   crgsz: ULONG;
                                   out pcElem: ULONG): HResult; stdcall;
...
function PropVariantToBooleanVectorAlloc(const propvar: MfPROPVARIANT;
                                         out pprgf: PBOOL;
                                         out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToBooleanVectorAlloc}

function PropVariantToInt16VectorAlloc(const propvar: MfPROPVARIANT;
                                       out pprgn: PSHORT;
                                       out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToInt16VectorAlloc}

function PropVariantToUInt16VectorAlloc(const propvar: MfPROPVARIANT;
                                        out pprgn: PUSHORT;
                                        out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToUInt16VectorAlloc}

function PropVariantToInt32VectorAlloc(const propvar: MfPROPVARIANT;
                                       out pprgn: PLONG;
                                       out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToInt32VectorAlloc}

function PropVariantToUInt32VectorAlloc(const propvar: MfPROPVARIANT;
                                        out pprgn: PULONG;
                                        out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToUInt32VectorAlloc}

function PropVariantToInt64VectorAlloc(const propvar: MfPROPVARIANT;
                                       out pprgn: PLONGLONG;
                                       out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToInt64VectorAlloc}

function PropVariantToUInt64VectorAlloc(const propvar: MfPROPVARIANT;
                                        out pprgn: PULONGLONG;
                                        out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToUInt64VectorAlloc}

function PropVariantToDoubleVectorAlloc(const propvar: MfPROPVARIANT;
                                        out pprgn: PDOUBLE;
                                        out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToDoubleVectorAlloc}

function PropVariantToFileTimeVectorAlloc(const propvar: MfPROPVARIANT;
                                          out pprgft: PFILETIME;
                                          out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToFileTimeVectorAlloc}

function PropVariantToStringVectorAlloc(const propvar: MfPROPVARIANT;
...
function PropVariantGetElem(const propvarIn: MfPROPVARIANT;
                            iElem: ULONG;
                            out ppropvar: MfPROPVARIANT): HResult; inline;
{$EXTERNALSYM PropVariantGetElem}

// Helpers
procedure ClearPropVariantArray(var rgPropVar: MfPROPVARIANT;
                                cVars: UINT); stdcall;
...
// Comparisons
function PropVariantCompareEx(const propvar1: MfPROPVARIANT;
                              const propvar2: MfPROPVARIANT;
                              _unit: PROPVAR_COMPARE_UNIT;
                              flags: PROPVAR_COMPARE_FLAGS): integer; stdcall;
{$EXTERNALSYM PropVariantCompareEx}

function PropVariantCompare(const propvar1: MfPROPVARIANT;
                            const propvar2: MfPROPVARIANT): integer; inline;
...
function PropVariantChangeType(var ppropvarDest: MfPROPVARIANT;
                               const propvarSrc: MfPROPVARIANT;
                               flags: PROPVAR_CHANGE_FLAGS;
                               vt: VARTYPE): HResult; stdcall;
{$EXTERNALSYM PropVariantChangeType}

function PropVariantToVariant(const pPropVar: MfPROPVARIANT;
...
{$EXTERNALSYM VariantToPropVariant}
 ...
 // Stg functions
function StgSerializePropVariant(const ppropvar: MfPROPVARIANT;
