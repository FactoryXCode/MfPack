...
type
  ...
  POLESTRLIST = ^OLESTRLIST;
  OLESTRLIST = array[0..65535] of POLESTR;
  ...
  tagQACONTAINERFLAGS             = (
    QACONTAINER_SHOWHATCHING      = $0001,
    QACONTAINER_SHOWGRABHANDLES   = $0002,
    QACONTAINER_USERMODE          = $0004,
    QACONTAINER_DISPLAYASDEFAULT  = $0008,
    QACONTAINER_UIDEAD            = $0010,
    QACONTAINER_AUTOCLIP          = $0020,
    QACONTAINER_MESSAGEREFLECT    = $0040,
    QACONTAINER_SUPPORTSMNEMONICS = $0080);
