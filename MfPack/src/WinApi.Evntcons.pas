...
const
  ...
  EVENT_HEADER_EXT_TYPE_CONTAINER_ID       = $0010;
  {$EXTERNALSYM EVENT_HEADER_EXT_TYPE_CONTAINER_ID}
  EVENT_HEADER_EXT_TYPE_STACK_KEY32        = $0011;
  {$EXTERNALSYM EVENT_HEADER_EXT_TYPE_STACK_KEY32}
  EVENT_HEADER_EXT_TYPE_STACK_KEY64        = $0012;
  {$EXTERNALSYM EVENT_HEADER_EXT_TYPE_STACK_KEY64}
  EVENT_HEADER_EXT_TYPE_MAX                = $0013;
...
// #define EVENT_HEADER_EXTENDED_DATA_ITEM_DEF
 ...
 _EVENT_HEADER_EXTENDED_DATA_ITEM = record
  ...
  {$EXTERNALSYM PEVENT_EXTENDED_ITEM_INSTANCE}
  ...
  {$EXTERNALSYM PEVENT_EXTENDED_ITEM_RELATED_ACTIVITYID}
  ...
  {$EXTERNALSYM PEVENT_EXTENDED_ITEM_TS_ID}
  ...
  {$EXTERNALSYM PEVENT_EXTENDED_ITEM_STACK_TRACE32}
  ...
  {$EXTERNALSYM PEVENT_EXTENDED_ITEM_STACK_TRACE64}
  ...
  PEVENT_EXTENDED_ITEM_STACK_KEY32 = ^EVENT_EXTENDED_ITEM_STACK_KEY32;
  {$EXTERNALSYM PEVENT_EXTENDED_ITEM_STACK_KEY32}
  _EVENT_EXTENDED_ITEM_STACK_KEY32 = record
    MatchId: ULONG64;
    StackKey: ULONG;
    Padding: ULONG;
  end;
  {$EXTERNALSYM _EVENT_EXTENDED_ITEM_STACK_KEY32}
  EVENT_EXTENDED_ITEM_STACK_KEY32 = _EVENT_EXTENDED_ITEM_STACK_KEY32;
  {$EXTERNALSYM EVENT_EXTENDED_ITEM_STACK_KEY32}


  PEVENT_EXTENDED_ITEM_STACK_KEY64 = ^EVENT_EXTENDED_ITEM_STACK_KEY64;
  {$EXTERNALSYM PEVENT_EXTENDED_ITEM_STACK_KEY64}
  _EVENT_EXTENDED_ITEM_STACK_KEY64 = record
    MatchId: ULONG64;
    StackKey: ULONG64;
  end;
  {$EXTERNALSYM _EVENT_EXTENDED_ITEM_STACK_KEY64}
 EVENT_EXTENDED_ITEM_STACK_KEY64 = _EVENT_EXTENDED_ITEM_STACK_KEY64;
 {$EXTERNALSYM EVENT_EXTENDED_ITEM_STACK_KEY64}
...
{ 10.0.28000.0  }
  EVENT_HEADER_FLAG_RESERVED1           = $0400;
  {$EXTERNALSYM EVENT_HEADER_FLAG_RESERVED1}
