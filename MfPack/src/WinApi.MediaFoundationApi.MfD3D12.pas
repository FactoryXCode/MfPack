...
const
  ...
  // {a4940b20-cfd6-4738-9d02-98-11-37-34-01-5a}
  MF_MT_D3D12_RESOURCE_FLAG_ALLOW_SIMULTANEOUS_ACCESS : TGUID = (D1: $a4940b20;
                                                                 D2: $cfd6;
                                                                 D3: $4738;
...
const
  mfd3d12Lib = 'mfplat.dll';


{$WARN SYMBOL_PLATFORM OFF}
  function MFCreateD3D12SynchronizationObject; external mfd3d12Lib name 'MFCreateD3D12SynchronizationObject' {$IF COMPILERVERSION > 20.0} delayed {$ENDIF};
