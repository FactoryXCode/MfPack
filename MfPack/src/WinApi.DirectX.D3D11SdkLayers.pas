...
// Module: WinApi.DirectX.D3D11SdkLayers.pas
// Kind: Pascal / Delphi unit
// Release date: 13-08-2025
// Language: ENU
//
// Revision Version: 3.2.0
// Description: An information-queue interface stores,
//              retrieves, and filters debug messages.
//              The queue consists of a message queue,
...
//------------------------------------------------------------------------------
//
// Remarks: Contains interface definitions for the D3D11 SDK Layers.
//
// Related objects: -
...
//
//==============================================================================
unit WinApi.DirectX.D3D11SdkLayers;

  {$HPPEMIT '#include "d3d11sdklayers.h"'}
...
//==============================================================================
  ...
  {$EXTERNALSYM D3D11_DEBUG_FEATURE_ALWAYS_DISCARD_OFFERED_RESOURCE}
  D3D11_DEBUG_FEATURE_NEVER_DISCARD_OFFERED_RESOURCE = $10;
  {$EXTERNALSYM D3D11_DEBUG_FEATURE_NEVER_DISCARD_OFFERED_RESOURCE}
  D3D11_DEBUG_FEATURE_AVOID_BEHAVIOR_CHANGING_DEBUG_AIDS = $40;
  {$EXTERNALSYM D3D11_DEBUG_FEATURE_AVOID_BEHAVIOR_CHANGING_DEBUG_AIDS}
  D3D11_DEBUG_FEATURE_DISABLE_TILED_RESOURCE_MAPPING_TRACKING_AND_VALIDATION = $80;
  {$EXTERNALSYM D3D11_DEBUG_FEATURE_DISABLE_TILED_RESOURCE_MAPPING_TRACKING_AND_VALIDATION}


  D3D11_REGKEY_PATH: PWideChar = 'Software\Microsoft\Direct3D';
  {$EXTERNALSYM D3D11_REGKEY_PATH}
  D3D11_MUTE_DEBUG_OUTPUT: PWideChar = 'MuteDebugOutput';
  {$EXTERNALSYM D3D11_MUTE_DEBUG_OUTPUT}
  D3D11_ENABLE_BREAK_ON_MESSAGE: PWideChar = 'EnableBreakOnMessage';
  {$EXTERNALSYM D3D11_ENABLE_BREAK_ON_MESSAGE}
  D3D11_INFOQUEUE_STORAGE_FILTER_OVERRIDE: PWideChar = 'InfoQueueStorageFilterOverride';
  {$EXTERNALSYM D3D11_INFOQUEUE_STORAGE_FILTER_OVERRIDE}
  D3D11_MUTE_CATEGORY: PWideChar = 'Mute_CATEGORY_%s';
  {$EXTERNALSYM D3D11_MUTE_CATEGORY}
  D3D11_MUTE_SEVERITY: PWideChar = 'Mute_SEVERITY_%s';
  {$EXTERNALSYM D3D11_MUTE_SEVERITY}
  D3D11_MUTE_ID_STRING: PWideChar = 'Mute_ID_%s';
  {$EXTERNALSYM D3D11_MUTE_ID_STRING}
  D3D11_MUTE_ID_DECIMAL: PWideChar = 'Mute_ID_%d';
  {$EXTERNALSYM D3D11_MUTE_ID_DECIMAL}
  D3D11_UNMUTE_SEVERITY_INFO: PWideChar = 'Unmute_SEVERITY_INFO';
  {$EXTERNALSYM D3D11_UNMUTE_SEVERITY_INFO}
  D3D11_BREAKON_CATEGORY: PWideChar = 'BreakOn_CATEGORY_%s';
  {$EXTERNALSYM D3D11_BREAKON_CATEGORY}
  D3D11_BREAKON_SEVERITY: PWideChar = 'BreakOn_SEVERITY_%s';
  {$EXTERNALSYM D3D11_BREAKON_SEVERITY}
  D3D11_BREAKON_ID_STRING: PWideChar = 'BreakOn_ID_%s';
  {$EXTERNALSYM D3D11_BREAKON_ID_STRING}
  D3D11_BREAKON_ID_DECIMAL: PWideChar = 'BreakOn_ID_%d';
  {$EXTERNALSYM D3D11_BREAKON_ID_DECIMAL}
  D3D11_APPSIZE_STRING: PWideChar = 'Size';
  {$EXTERNALSYM D3D11_APPSIZE_STRING}
  D3D11_APPNAME_STRING: PWideChar = 'Name';
  {$EXTERNALSYM D3D11_APPNAME_STRING}
  D3D11_FORCE_DEBUGGABLE: PWideChar = 'ForceDebuggable';
  {$EXTERNALSYM D3D11_FORCE_DEBUGGABLE}
  D3D11_FORCE_SHADER_SKIP_OPTIMIZATION: PWideChar = 'ForceShaderSkipOptimization';
  {$EXTERNALSYM D3D11_FORCE_SHADER_SKIP_OPTIMIZATION}


type
  D3D11_RLDO_FLAGS = type UINT;
...
const
  ...
  {$EXTERNALSYM D3D11_RLDO_IGNORE_INTERNAL}

type
  D3D11_SHADER_TRACKING_RESOURCE_TYPE = type UINT;
  {$EXTERNALSYM D3D11_SHADER_TRACKING_RESOURCE_TYPE}

const
  D3D11_SHADER_TRACKING_RESOURCE_TYPE_NONE = 0;
  {$EXTERNALSYM D3D11_SHADER_TRACKING_RESOURCE_TYPE_NONE}
  D3D11_SHADER_TRACKING_RESOURCE_TYPE_UAV_DEVICEMEMORY = 1;
  {$EXTERNALSYM D3D11_SHADER_TRACKING_RESOURCE_TYPE_UAV_DEVICEMEMORY}
  D3D11_SHADER_TRACKING_RESOURCE_TYPE_NON_UAV_DEVICEMEMORY = 2;
  {$EXTERNALSYM D3D11_SHADER_TRACKING_RESOURCE_TYPE_NON_UAV_DEVICEMEMORY}
  D3D11_SHADER_TRACKING_RESOURCE_TYPE_ALL_DEVICEMEMORY = 3;
  {$EXTERNALSYM D3D11_SHADER_TRACKING_RESOURCE_TYPE_ALL_DEVICEMEMORY}
  D3D11_SHADER_TRACKING_RESOURCE_TYPE_GROUPSHARED_MEMORY = 4;
  {$EXTERNALSYM D3D11_SHADER_TRACKING_RESOURCE_TYPE_GROUPSHARED_MEMORY}
  D3D11_SHADER_TRACKING_RESOURCE_TYPE_ALL_SHARED_MEMORY = 5;
  {$EXTERNALSYM D3D11_SHADER_TRACKING_RESOURCE_TYPE_ALL_SHARED_MEMORY}
  D3D11_SHADER_TRACKING_RESOURCE_TYPE_GROUPSHARED_NON_UAV = 6;
  {$EXTERNALSYM D3D11_SHADER_TRACKING_RESOURCE_TYPE_GROUPSHARED_NON_UAV}
  D3D11_SHADER_TRACKING_RESOURCE_TYPE_ALL = 7;
  {$EXTERNALSYM D3D11_SHADER_TRACKING_RESOURCE_TYPE_ALL}

type

  D3D11_SHADER_TRACKING_OPTIONS = type UINT;
  {$EXTERNALSYM D3D11_SHADER_TRACKING_OPTIONS}

const

  D3D11_SHADER_TRACKING_OPTION_IGNORE = 0;
  {$EXTERNALSYM D3D11_SHADER_TRACKING_OPTION_IGNORE}
  D3D11_SHADER_TRACKING_OPTION_TRACK_UNINITIALIZED = $1; // track reading uninitialized data
  {$EXTERNALSYM D3D11_SHADER_TRACKING_OPTION_TRACK_UNINITIALIZED}
  D3D11_SHADER_TRACKING_OPTION_TRACK_RAW = $2; // track read-after-write hazards
  {$EXTERNALSYM D3D11_SHADER_TRACKING_OPTION_TRACK_RAW}
  D3D11_SHADER_TRACKING_OPTION_TRACK_WAR = $4; // track write-after-read hazards
  {$EXTERNALSYM D3D11_SHADER_TRACKING_OPTION_TRACK_WAR}
  D3D11_SHADER_TRACKING_OPTION_TRACK_WAW = $8; // track write-after-write hazards
  {$EXTERNALSYM D3D11_SHADER_TRACKING_OPTION_TRACK_WAW}
  D3D11_SHADER_TRACKING_OPTION_ALLOW_SAME = $10;  // allow a hazard if the data
  {$EXTERNALSYM D3D11_SHADER_TRACKING_OPTION_ALLOW_SAME}

  D3D11_SHADER_TRACKING_OPTION_TRACK_ATOMIC_CONSISTENCY = $20; // make sure only one type of atomic
                                                               // is used on an address
                                                               // written didn't change the value
  {$EXTERNALSYM D3D11_SHADER_TRACKING_OPTION_TRACK_ATOMIC_CONSISTENCY}
  D3D11_SHADER_TRACKING_OPTION_TRACK_RAW_ACROSS_THREADGROUPS = $40; // track read-after-write hazards
                                                                    // across thread groups
  {$EXTERNALSYM D3D11_SHADER_TRACKING_OPTION_TRACK_RAW_ACROSS_THREADGROUPS}

  D3D11_SHADER_TRACKING_OPTION_TRACK_WAR_ACROSS_THREADGROUPS = $80; // track write-after-read hazards
                                                                    // across thread groups
  {$EXTERNALSYM D3D11_SHADER_TRACKING_OPTION_TRACK_WAR_ACROSS_THREADGROUPS}

  D3D11_SHADER_TRACKING_OPTION_TRACK_WAW_ACROSS_THREADGROUPS = $100; // track write-after-write hazards
                                                                     // across thread groups
  {$EXTERNALSYM D3D11_SHADER_TRACKING_OPTION_TRACK_WAW_ACROSS_THREADGROUPS}

  D3D11_SHADER_TRACKING_OPTION_TRACK_ATOMIC_CONSISTENCY_ACROSS_THREADGROUPS = $200; // make sure only one type of atomic
                                                                                    // is used on an address
                                                                                    // across thread groups
  {$EXTERNALSYM D3D11_SHADER_TRACKING_OPTION_TRACK_ATOMIC_CONSISTENCY_ACROSS_THREADGROUPS}

  D3D11_SHADER_TRACKING_OPTION_UAV_SPECIFIC_FLAGS = D3D11_SHADER_TRACKING_OPTION_TRACK_RAW_ACROSS_THREADGROUPS or
                                                    D3D11_SHADER_TRACKING_OPTION_TRACK_WAR_ACROSS_THREADGROUPS or
                                                    D3D11_SHADER_TRACKING_OPTION_TRACK_WAW_ACROSS_THREADGROUPS or
                                                    D3D11_SHADER_TRACKING_OPTION_TRACK_ATOMIC_CONSISTENCY_ACROSS_THREADGROUPS; // flags ignored for GSM
  {$EXTERNALSYM D3D11_SHADER_TRACKING_OPTION_UAV_SPECIFIC_FLAGS}

  D3D11_SHADER_TRACKING_OPTION_ALL_HAZARDS = D3D11_SHADER_TRACKING_OPTION_TRACK_RAW or
                                             D3D11_SHADER_TRACKING_OPTION_TRACK_WAR or
                                             D3D11_SHADER_TRACKING_OPTION_TRACK_WAW or
                                             D3D11_SHADER_TRACKING_OPTION_TRACK_ATOMIC_CONSISTENCY or
                                             D3D11_SHADER_TRACKING_OPTION_TRACK_RAW_ACROSS_THREADGROUPS or
                                             D3D11_SHADER_TRACKING_OPTION_TRACK_WAR_ACROSS_THREADGROUPS or
                                             D3D11_SHADER_TRACKING_OPTION_TRACK_WAW_ACROSS_THREADGROUPS or
                                             D3D11_SHADER_TRACKING_OPTION_TRACK_ATOMIC_CONSISTENCY_ACROSS_THREADGROUPS;
  {$EXTERNALSYM D3D11_SHADER_TRACKING_OPTION_ALL_HAZARDS}

  D3D11_SHADER_TRACKING_OPTION_ALL_HAZARDS_ALLOWING_SAME = D3D11_SHADER_TRACKING_OPTION_ALL_HAZARDS or
                                                           D3D11_SHADER_TRACKING_OPTION_ALLOW_SAME;
  {$EXTERNALSYM D3D11_SHADER_TRACKING_OPTION_ALL_HAZARDS_ALLOWING_SAME}

  D3D11_SHADER_TRACKING_OPTION_ALL_OPTIONS = D3D11_SHADER_TRACKING_OPTION_ALL_HAZARDS_ALLOWING_SAME or
                                             D3D11_SHADER_TRACKING_OPTION_TRACK_UNINITIALIZED;
  {$EXTERNALSYM D3D11_SHADER_TRACKING_OPTION_ALL_OPTIONS}

type

   PD3D11_MESSAGE_CATEGORY = ^D3D11_MESSAGE_CATEGORY;
   {$EXTERNALSYM PD3D11_MESSAGE_CATEGORY}
 ...
 {$EXTERNALSYM D3D11_MESSAGE_CATEGORY}
  ...
  {$EXTERNALSYM PD3D11_MESSAGE_SEVERITY}
...
type
  ...
  PD3D11_INFO_QUEUE_FILTER_DESC = ^D3D11_INFO_QUEUE_FILTER_DESC;
  {$EXTERNALSYM PD3D11_INFO_QUEUE_FILTER_DESC}
  ...
  {$EXTERNALSYM PD3D11_INFO_QUEUE_FILTER}
...
type
  ...
  // =============================
  //
  {$HPPEMIT 'DECLARE_DINTERFACE_TYPE(ID3D11TracingDevice);'}
  {$EXTERNALSYM ID3D11TracingDevice}
  ID3D11TracingDevice = interface(IUnknown)
  ['{1911C771-1587-413E-A7E0-FB26C3DE0268}']

    function SetShaderTrackingOptionsByType(ResourceTypeFlags: UINT;
                                            Options: UINT): HResult; stdcall;

    function SetShaderTrackingOptions(pShader: IUnknown;
                                      Options: UINT): HResult; stdcall;
  end;
  IID_ID3D11TracingDevice = ID3D11TracingDevice;
  {$EXTERNALSYM IID_ID3D11TracingDevice}


  // Interface ID3D11RefTrackingOptions
  // ==================================
  //
  {$HPPEMIT 'DECLARE_DINTERFACE_TYPE(ID3D11RefTrackingOptions);'}
  {$EXTERNALSYM ID3D11RefTrackingOptions}
  ...
  IID_ID3D11RefTrackingOptions = ID3D11RefTrackingOptions;
  {$EXTERNALSYM IID_ID3D11RefTrackingOptions}
...
type
  ...
  ['{6543DBB6-1B48-42F5-AB82-E97EC74326F6}']
    ...
    function GetStorageFilter(pFilter: PD3D11_INFO_QUEUE_FILTER;
    ...
    function GetRetrievalFilter(pFilter: PD3D11_INFO_QUEUE_FILTER;
                                var pFilterByteLength: SIZE_T): HResult; stdcall;
    ...
    function AddMessage(Category: D3D11_MESSAGE_CATEGORY;
                        Severity: D3D11_MESSAGE_SEVERITY;
                        ID: D3D11_MESSAGE_ID;
                        pDescription: LPCSTR): HResult; stdcall;

    function AddApplicationMessage(Severity: D3D11_MESSAGE_SEVERITY;
                                   pDescription: LPCSTR): HResult; stdcall;

    function SetBreakOnCategory(Category: D3D11_MESSAGE_CATEGORY;
                                bEnable: BOOL): HResult; stdcall;

    function SetBreakOnSeverity(Severity: D3D11_MESSAGE_SEVERITY;
                                bEnable: BOOL): HResult; stdcall;
