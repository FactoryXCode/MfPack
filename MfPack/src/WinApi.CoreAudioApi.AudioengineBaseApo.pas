...
type
  ...
  {$EXTERNALSYM IApoAuxiliaryInputConfiguration}
  IApoAuxiliaryInputConfiguration = interface(IUnknown)
  ['{4CEB0AAB-FA19-48ED-A857-87771AE1B768}']
    function AddAuxiliaryInput({in} dwInputId: DWORD;
                               {in} cbDataSize: UINT32;
                               {in} pbyData: PByte;
                               {in} pInputConnection: APO_CONNECTION_DESCRIPTOR): HResult; stdcall;
    // Description:
    //
    ...
    function RemoveAuxiliaryInput({in} dwInputId: DWORD): HResult; stdcall;
    // Description:
    //
  ...
  IID_IApoAuxiliaryInputConfiguration = IApoAuxiliaryInputConfiguration;
  {$EXTERNALSYM IID_IApoAuxiliaryInputConfiguration}
  ...
  //
  {$HPPEMIT '  DECLARE_DINTERFACE_TYPE(IUnknown);'}
  {$EXTERNALSYM IApoAuxiliaryInputRT}
  IApoAuxiliaryInputRT = interface(IUnknown)
  ['{F851809C-C177-49A0-B1B2-B66F017943AB}']
    procedure AcceptInput({in} dwInputId: DWORD;
                          {in} pInputConnection: APO_CONNECTION_PROPERTY);
    // Description:
    //
  ...
  IID_IApoAuxiliaryInputRT = IApoAuxiliaryInputRT;
  {$EXTERNALSYM IID_IApoAuxiliaryInputRT}
  ...
  //
  {$HPPEMIT '  DECLARE_DINTERFACE_TYPE(IUnknown);'}
  {$EXTERNALSYM IApoAcousticEchoCancellation}
  IApoAcousticEchoCancellation = interface(IUnknown)
