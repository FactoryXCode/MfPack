...
type
  ...
  XAUDIO2FX_VOLUMEMETER_LEVELS = record
    pPeakLevels: PFloat;              // Peak levels table: receives maximum absolute level for each channel
                                      // over a processing pass; may be nil if pRMSLevls >= nil,
                                      // otherwise must have at least ChannelCount elements.
    pRMSLevels: PFloat;               // Root mean square levels table: receives RMS level for each channel
...
// Direct parameters
    RoomFilterFreq: FLOAT;           // [20, 20000] in Hz
    RoomFilterMain: FLOAT;           // [-100, 0] in dB
    RoomFilterHF: FLOAT;             // [-100, 0] in dB
    ReflectionsGain: FLOAT;          // [-100, 20] in dB
    ReverbGain: FLOAT;               // [-100, 20] in dB
    DecayTime: FLOAT;                // [0.1, inf] in seconds
    Density: FLOAT;                  // [0, 100] (percentage)
    RoomSize: FLOAT;                 // [1, 100] in feet
// component control
...
const
  ...
  XAUDIO2FX_REVERB_MIN_WET_DRY_MIX         : FLOAT = 0.0;
  ...
  XAUDIO2FX_REVERB_MIN_ROOM_FILTER_FREQ    : FLOAT = 20.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_MIN_ROOM_FILTER_FREQ}
  XAUDIO2FX_REVERB_MIN_ROOM_FILTER_MAIN    : FLOAT = -100.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_MIN_ROOM_FILTER_MAIN}
  XAUDIO2FX_REVERB_MIN_ROOM_FILTER_HF      : FLOAT = -100.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_MIN_ROOM_FILTER_HF}
  XAUDIO2FX_REVERB_MIN_REFLECTIONS_GAIN    : FLOAT = -100.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_MIN_REFLECTIONS_GAIN}
  XAUDIO2FX_REVERB_MIN_REVERB_GAIN         : FLOAT = -100.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_MIN_REVERB_GAIN}
  XAUDIO2FX_REVERB_MIN_DECAY_TIME          : FLOAT = 0.1;
  {$EXTERNALSYM XAUDIO2FX_REVERB_MIN_DECAY_TIME}
  XAUDIO2FX_REVERB_MIN_DENSITY             : FLOAT = 0.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_MIN_DENSITY}
  XAUDIO2FX_REVERB_MIN_ROOM_SIZE           : FLOAT = 0.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_MIN_ROOM_SIZE}

  XAUDIO2FX_REVERB_MAX_WET_DRY_MIX         : FLOAT = 100.0;
  ...
  XAUDIO2FX_REVERB_MAX_ROOM_FILTER_FREQ    : FLOAT = 20000.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_MAX_ROOM_FILTER_FREQ}
  XAUDIO2FX_REVERB_MAX_ROOM_FILTER_MAIN    : FLOAT = 0.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_MAX_ROOM_FILTER_MAIN}
  XAUDIO2FX_REVERB_MAX_ROOM_FILTER_HF      : FLOAT = 0.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_MAX_ROOM_FILTER_HF}
  XAUDIO2FX_REVERB_MAX_REFLECTIONS_GAIN    : FLOAT = 20.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_MAX_REFLECTIONS_GAIN}
  XAUDIO2FX_REVERB_MAX_REVERB_GAIN         : FLOAT = 20.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_MAX_REVERB_GAIN}
  XAUDIO2FX_REVERB_MAX_DENSITY             : FLOAT = 100.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_MAX_DENSITY}
  XAUDIO2FX_REVERB_MAX_ROOM_SIZE           : FLOAT = 100.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_MAX_ROOM_SIZE}

  XAUDIO2FX_REVERB_DEFAULT_WET_DRY_MIX        : FLOAT = 100.0;
  ...
  XAUDIO2FX_REVERB_DEFAULT_ROOM_FILTER_FREQ   : FLOAT = 5000.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_DEFAULT_ROOM_FILTER_FREQ}
  XAUDIO2FX_REVERB_DEFAULT_ROOM_FILTER_MAIN   : FLOAT = 0.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_DEFAULT_ROOM_FILTER_MAIN}
  XAUDIO2FX_REVERB_DEFAULT_ROOM_FILTER_HF     : FLOAT = 0.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_DEFAULT_ROOM_FILTER_HF}
  XAUDIO2FX_REVERB_DEFAULT_REFLECTIONS_GAIN   : FLOAT = 0.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_DEFAULT_REFLECTIONS_GAIN}
  XAUDIO2FX_REVERB_DEFAULT_REVERB_GAIN        : FLOAT = 0.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_DEFAULT_REVERB_GAIN}
  XAUDIO2FX_REVERB_DEFAULT_DECAY_TIME         : FLOAT = 1.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_DEFAULT_DECAY_TIME}
  XAUDIO2FX_REVERB_DEFAULT_DENSITY            : FLOAT = 100.0;
  {$EXTERNALSYM XAUDIO2FX_REVERB_DEFAULT_DENSITY}
  XAUDIO2FX_REVERB_DEFAULT_ROOM_SIZE          : FLOAT = 100.0;
...
type
  ...
  // Standard I3DL2 parameters
    ...
    RoomRolloffFactor: FLOAT;        // [0.0, 10.0]
    DecayTime: FLOAT;                // [0.1, 20.0] in seconds
    DecayHFRatio: FLOAT;             // [0.1, 2.0]
    Reflections: INT32;              // [-10000, 1000] in mB (hundredths of decibels)
    ReflectionsDelay: FLOAT;         // [0.0, 0.3] in seconds
    Reverb: INT32;                   // [-10000, 2000] in mB (hundredths of decibels)
    ReverbDelay: FLOAT;              // [0.0, 0.1] in seconds
    Diffusion: FLOAT;                // [0.0, 100.0] (percentage)
    Density: FLOAT;                  // [0.0, 100.0] (percentage)
    HFReference: FLOAT;              // [20.0, 20000.0] in Hz
  end;
