...
// INTERFACES //////////////////////////////////////////////////////////////////
  ...
  ['{9c906818-31d7-4fd3-a151-7c5e225db55a}']
    ...
    // Standard HRESULT error code.
    // </returns>
    function SetIncrementalTabStop(incrementalTabStop: FLOAT): HResult; stdcall;
    ...
    function SetLineSpacing(lineSpacingMethod: DWRITE_LINE_SPACING_METHOD;
                            lineSpacing: FLOAT;
                            baseline: FLOAT): HResult; stdcall;
    ...
    function GetLineSpacing(out lineSpacingMethod: DWRITE_LINE_SPACING_METHOD;
                            out lineSpacing: FLOAT;
                            out baseline: FLOAT): HResult; stdcall;
 ...
 IDWriteTextAnalyzer = interface(IUnknown)
  ...
  DWRITE_TEXT_METRICS = record
    ...
    left: FLOAT;       // Top-most point of formatted text relative to layout box
    // (excluding any glyph overhang).
    top: FLOAT;
  ...
  ['{eaf3a2da-ecf4-4d24-b644-b34f6842024b}']
    ...
    function GetPixelsPerDip(clientDrawingContext: Pointer;
                             out pixelsPerDip: FLOAT): HResult; stdcall;
  ...
  ['{53737037-6d14-410b-9bfe-0b182bb70961}']
    ...
    // Standard HRESULT error code.
    // </returns>
    function HitTestPoint(pointX: FLOAT;
                          pointY: FLOAT;
  ...
  ['{5e5a32a3-8dff-4773-9ff6-0696eab77267}']
    ...
    // Standard HRESULT error code.
    // </returns>
    function DrawGlyphRun(baselineOriginX: FLOAT;
                          baselineOriginY: FLOAT;
                          measuringMode: DWRITE_MEASURING_MODE;
                          glyphRun: DWRITE_GLYPH_RUN;
                          renderingParams: IDWriteRenderingParams;
    ...
    // </returns>
    function GetPixelsPerDip(): FLOAT; stdcall;
    ...
    // Standard HRESULT error code.
    // </returns>
    function SetPixelsPerDip(pixelsPerDip: FLOAT): HResult; stdcall;
  ...
  ['{7d97dbf7-e085-42d4-81e3-6a883bded118}']
    ...
    function GetAlphaBlendParams(renderingParams: IDWriteRenderingParams;
                                 out blendGamma: FLOAT;
                                 out blendEnhancedContrast: FLOAT;
                                 out blendClearTypeLevel: FLOAT): HResult; stdcall;
