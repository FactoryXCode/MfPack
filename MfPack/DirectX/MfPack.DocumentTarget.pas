...
// Module: MfPack.DocumentTarget.pas
...
//#if (NTDDI_VERSION >= NTDDI_WIN7)
  ...
  ['{1b8efec4-3019-4c27-964e-367202156906}']
    ...
    function GetPackageTarget({in} const guidTargetType: REFGUID;
                              {in} const riid: REFIID;
  ...
  ['{d2959bf7-b31b-4a3d-9600-712eb1335ba4}']
    ...
    function CreateDocumentPackageTargetForPrintJob({in} printerName: LPCWSTR;
                                                    {in} jobName: LPCWSTR;
