...
const
  ...
  COPP_HDCP_ForceDWORD = FORCEDWORD;
...
const
  ...
  COPP_CGMSA_ForceDWORD = FORCEDWORD;
...
const
  ...
  COPP_ACP_ForceDWORD = FORCEDWORD;
...
type
  ...
  _COPP_ConnectorType                      = (
    ...
    COPP_ConnectorType_ForceDWORD          = FORCEDWORD     // force 32-bit size enum
  );
...
type
  ...
  _COPP_BusType             = (
    ...
    COPP_BusType_ForceDWORD = FORCEDWORD     // force 32-bit size enum
  );
