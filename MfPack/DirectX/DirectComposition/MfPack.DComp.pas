...
// #if (NTDDI_VERSION >= NTDDI_WIN8)
  ...
  ['{E57AA735-DCDB-4c72-9C61-0591F58889EE}']
    ...
    function SetAngleX(angleX: FLOAT): HResult; stdcall;
    ...
    function SetAngleY(angleY: FLOAT): HResult; stdcall;
...
// #pragma warning(disable : 4995)    //D3DMATRIX': name was marked as #pragma deprecated
  ...
  ['{9842AD7D-D9CF-4908-AED7-48B51DA5E7C2}']
    ...
    function SetLeft(left: FLOAT): HResult; stdcall;
    ...
    function SetTop(top: FLOAT): HResult; stdcall;
    ...
    function SetRight(right: FLOAT): HResult; stdcall;
    ...
    function SetBottom(bottom: FLOAT): HResult; stdcall;
    ...
    function SetTopLeftRadiusX(radius: FLOAT): HResult; stdcall;
    ...
    // top-left corner of the clip.
    function SetTopLeftRadiusY(radius: FLOAT): HResult; stdcall;
    ...
    function SetTopRightRadiusX(radius: FLOAT): HResult; stdcall;
    ...
    // Changes the value of the y radius of the ellipse that rounds the
    // top-right corner of the clip.
    function SetTopRightRadiusY(radius: FLOAT): HResult; stdcall;
    ...
    function SetBottomLeftRadiusX(radius: FLOAT): HResult; stdcall;
    ...
    // Changes the value of the y radius of the ellipse that rounds the
    // bottom-left corner of the clip.
    function SetBottomLeftRadiusY(radius: FLOAT): HResult; stdcall;
    ...
    function SetBottomRightRadiusX(radius: FLOAT): HResult; stdcall;
    ...
    // Changes the value of the y radius of the ellipse that rounds the
    // bottom-right corner of the clip.
    function SetBottomRightRadiusY(radius: FLOAT): HResult; stdcall;
...
// #if (_WIN32_WINNT >= _WIN32_WINNT_WINTHRESHOLD)
  ...
  ['{9B7E82E2-69C5-4EB4-A5F5-A7033F5132CD}']
    ...
    function SetRedTable(tableValues: FLOAT;
                         count: UINT): HResult; stdcall;

    function SetGreenTable(tableValues: FLOAT;
                           count: UINT): HResult; stdcall;

    function SetBlueTable(tableValues: FLOAT;
                          count: UINT): HResult; stdcall;

    function SetAlphaTable(tableValues: FLOAT;
                           count: UINT): HResult; stdcall;
