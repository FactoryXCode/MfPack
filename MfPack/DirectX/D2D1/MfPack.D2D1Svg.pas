...
// INTERFACES //////////////////////////////////////////////////////////////////
  ...
  ['{f1c0ca52-92a3-4f00-b4ce-f35691efd9d9}']
    ...
    function UpdateDashes(dashes: PFLOAT;
                          dashesCount: UINT32;
    ...
    function GetDashes(out dashes: PFLOAT;
                       dashesCount: UINT32;
                       startIndex: UINT32 = 0): HResult; overload; stdcall;
  ...
  ID2D1SvgPathData = interface(ID2D1SvgAttribute)
   ['{c095e4f4-bb98-43d6-9745-4d1b84ec9888}']
    ...
    function UpdateSegmentData(data: PFLOAT;
                               dataCount: UINT32;
                               startIndex: UINT32 = 0): HResult; stdcall;
    ...
    // </param>
    function GetSegmentData(out data: PFLOAT;
                            dataCount: UINT32;
                            startIndex: UINT32 = 0): HResult; stdcall;
  ...
  ID2D1SvgDocument = interface(ID2D1Resource)
   ['{86b88e4d-afa4-4d7b-88e4-68a51c4a0aec}']
    ...
    function FindElementById(id: PCWSTR;
    ...
    // element.
    function CreatePathData(segmentData: PFLOAT;
