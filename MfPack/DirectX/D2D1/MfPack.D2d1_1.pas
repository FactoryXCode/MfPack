...
const
    D2D1_LAYER_OPTIONS1_NONE                       = DWord(0);
    D2D1_LAYER_OPTIONS1_INITIALIZE_FROM_BACKGROUND = DWord(1);
    D2D1_LAYER_OPTIONS1_IGNORE_ALPHA               = DWord(2);    
...
type
 ...
 // property.
  ...
  // D2D1_BITMAP_OPTIONS is Not usable as enum
  ...
  ['{62baa2d2-ab54-41b7-b872-787e0106a421}']
    ...
    function ComputePointAndSegmentAtLength(_length: FLOAT;
                                            startSegment: UINT32;
  ...
  ['{483473d7-cd46-4f9d-9d3a-3112aa80159d}']
    ...
    function GetPropertyIndex(name: PCWSTR): UINT32; stdcall;


    // Sets the value of the given property using its name.
    function SetValueByName(name: PCWSTR;
    ...
    // sub-properties.
    function GetValueByName(name: PCWSTR;
                            _type: D2D1_PROPERTY_TYPE;
                            data: PByte;
                            dataSize: UINT32): HResult; stdcall;
  ...
  ['{e8f7fe7a-191c-466d-ad95-975678bda998}']
    ...
    function CreateColorContextFromFilename(filename: PCWSTR;
                                            out colorContext: ID2D1ColorContext): HResult; stdcall;
  ...
  ['{bb12d362-daee-4b9a-aa1d-14ba401cfa1f}']
    ...
    function RegisterEffectFromStream(const classId: REFCLSID;
                                      propertyXml: IStream;
    ...
    // This globally registers the given effect. The effect can later be instantiated
    // by using the registered class id. The effect registration is reference counted.
    function RegisterEffectFromString(const classId: REFCLSID;
                                      propertyXml: PCWSTR;
                                      bindings: PD2D1_PROPERTY_BINDING; // pointer to array
                                      bindingsCount: UINT32;
                                      effectFactory: PD2D1_EFFECT_FACTORY): HResult; stdcall;
    ...
    function UnregisterEffect(classId: REFCLSID): HResult; stdcall;
    ...
    // the system.</param>
    function GetRegisteredEffects({out} effects: PCLSID; // When this method returns, contains an array of effects. NULL if no effects are retrieved.
                                  effectsCount: UINT32;
    ...
    function GetEffectProperties(effectId: REFCLSID;
  ...
  procedure D2D1SinCos(angle: FLOAT;
                       out s: FLOAT;
                       out c: FLOAT); stdcall;
  {$EXTERNALSYM D2D1SinCos}

  function D2D1Tan(angle: FLOAT): FLOAT; stdcall;
  {$EXTERNALSYM D2D1Tan}

  function D2D1Vec3Length(x: FLOAT;
                          y: FLOAT;
                          z: FLOAT): FLOAT; stdcall;
