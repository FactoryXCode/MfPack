...
type
  ...
  ['{aec22fb8-76f3-4639-9be0-28eb43a67a2e}']
    ...
    //ULONG   Release();
    function SetPrivateData(const Name: REFGUID;
                            DataSize: UINT;
                            pData: Pointer): HResult; stdcall;

    function SetPrivateDataInterface(const Name: REFGUID;
                                     const pUnknown: IUnknown): HResult; stdcall;

    function GetPrivateData(const Name: REFGUID;
                            var pDataSize: UINT;
                      {out} pData: Pointer): HResult; stdcall;

    function GetParent(const riid: REFIID;
                       out ppParent {IUnknown} ): HResult; stdcall;
...
//--------------------------------------------------------------------------------------------------------
  ...
  ['{3d3e0379-f9de-4d58-bb6c-18d62992f1a6}']
    ...
    function GetDevice(const riid: REFIID;
                       out ppDevice {IUnknown} ): HResult; stdcall;
...
//--------------------------------------------------------------------------------------------------------
  ...
  ['{2411e7e1-12ac-4ccf-bd14-9798e8534dc0}']
    ...
    function CheckInterfaceSupport(const InterfaceName: REFGUID;
...
//--------------------------------------------------------------------------------------------------------
  ...
  ['{54ec77fa-1377-44e6-8c32-88fd5f44c84c}']
    ...
    function GetGPUThreadPriority(out pPriority: INT): HResult; stdcall;
...
//--------------------------------------------------------------------------------------------------------
  ...
  DXGI_DISPLAY_COLOR_SPACE = record
    PrimaryCoordinates: array[0..7, 0..1] of FLOAT;
    WhitePoints: array[0..15, 0..1] of FLOAT;
  end;
...
//--------------------------------------------------------------------------------------------------------
  ...
  function CreateDXGIFactory(const riid: REFIID;
                             out ppFactory: IDXGIFactory): HResult; stdcall
  {$EXTERNALSYM CreateDXGIFactory}

  function CreateDXGIFactory1(const riid: REFIID;
