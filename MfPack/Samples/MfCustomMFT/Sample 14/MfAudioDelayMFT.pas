...
//
// Version: 4.0.0
// Description: Extends the PCM delay MFT to accept caller-provided
//              output samples or allocate its own samples.
//
// Company: FactoryX
...
// Sample 14 extends the delay MFT with caller-allocated output samples.
