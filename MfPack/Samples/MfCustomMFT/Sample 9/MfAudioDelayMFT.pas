...
//
// Version: 4.0.0
// Description: An application-local PCM audio delay MFT translated from
//              the Microsoft MFT_AudioDelay sample.
//
// Company: FactoryX
...
// Application-local translation of Microsoft's MFT_AudioDelay example.
// TInterfacedObject supplies IUnknown; the class only implements IMFTransform.
...
begin
  ...
  try
    ...
    pStreamInfo.dwFlags := MFT_OUTPUT_STREAM_WHOLE_SAMPLES or
                           MFT_OUTPUT_STREAM_PROVIDES_SAMPLES or
