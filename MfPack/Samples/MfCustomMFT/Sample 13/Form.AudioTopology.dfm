object frmAudioTopology: TfrmAudioTopology
  Left = 0
  Top = 0
  Caption = 'MfCustomMFT Sample 13 - Seekable Audio Delay'
  ClientHeight = 435
  ClientWidth = 564
  Color = clBtnFace
  ...
  object tbTimeline: TTrackBar
    ...
    OnExit = tbTimelineExit
    OnKeyDown = tbTimelineKeyDown
    OnKeyUp = tbTimelineKeyUp
  end
  ...
  object tmrTimeline: TTimer
    Enabled = False
    Interval = 200
    OnTimer = tmrTimelineTimer
    Left = 454
    Top = 12
  end
end
