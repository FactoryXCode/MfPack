...
//
// Version: 4.0.0
// Description: The grayscale MFT as an explicit Media Session topology node.
//
// Company: FactoryX
...
begin
  ...
  memLog.Lines.Add('Open a video to build the Media Session topology.');
end;
...
begin
  ...
  memLog.Lines.Add('Creating partial topology...');
