...
type
  ...
  private
    ...
    /// <summary>Set sound pitch.</summary>
...
procedure TfrmMain.SetPitch(aValue: Integer);
var
  iSliderP: Single;
...
begin
  ...
  //if (trbPitch.Orientation = trVertical) then
  //  iSliderP := ((trbPitch.Max - trbPitch.Position) + trbPitch.Min) * 0.001
  //else
    iSliderP := (trbPitch.Position * 0.001);

  fXaudio2Engine.SetPitch(iSliderP);
end;
