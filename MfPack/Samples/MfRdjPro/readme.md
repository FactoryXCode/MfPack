...
This version does not need IceCast. Just Caddy will do.



What it does:
Uses MDI adding channeldecks, loopbackdecks, a microphonedeck,
effectsdeck (mft's) and enddeck (pa \& pfl, recorder (saves to WAV or FLAC) and Caddy broadcasting support),
...
We tested it, and it works without issues on Delphi XE7 and higher.
