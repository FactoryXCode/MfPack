...
process tree and the use of ActivateAudioInterfaceAsync Win32 API with a new initialization structure.  
...
It's preferred to select one process and select to record from this process only to get as less possible  
sound interruptions or distortions.  
