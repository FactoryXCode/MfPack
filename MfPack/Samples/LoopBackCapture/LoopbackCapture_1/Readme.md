...
Description:
  ...
  When encountering issues with the IAudioClient, a reset method is provided to reinitialize the engine.
  See: https://learn.microsoft.com/en-us/windows/win32/coreaudio/recovering-from-an-invalid-device-error.
