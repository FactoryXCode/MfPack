...
begin
  ...
  // Never overwrite a buffer which waveOut is still playing. If the render
  // endpoint falls behind, dropping one block is preferable to blocking the
  // capture callback and losing the input device.
