...
function CWasapiChat.HandlesMessage(_hwnd: HWND;
...
//
//  Returns "true" for the window messages we handle in our transport (only when wave in is rendered! See: WaveChat).
//
function CWasapiChat.MessageHandler(_hWnd: HWND;
