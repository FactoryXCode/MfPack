...
begin
  ...
  SetLength(Result, 0);
  MfCastAppendUInt16(Result, 0);
  MfCastAppendUInt16(Result, 0);
  MfCastAppendUInt16(Result, 1);
  MfCastAppendUInt16(Result, 0);
  MfCastAppendUInt16(Result, 0);
  MfCastAppendUInt16(Result, 0);
  MfCastAppendDnsName(Result, AServiceName);
  MfCastAppendUInt16(Result, MFCAST_DNS_TYPE_PTR);
  MfCastAppendUInt16(Result, MFCAST_DNS_CLASS_IN);
end;
...
function MfCastReadDnsName(const AData: TBytes; var AOffset: Integer;
