...
// Module: MfPack.MfMediaEngine.pas
...
type
  ...
  MF_MEDIA_ENGINE_ERR                     = (
    ...
    {$EXTERNALSYM MF_MEDIA_ENGINE_ERR_NOERROR}
    MF_MEDIA_ENGINE_ERR_ABORTED           = 1,
    {$EXTERNALSYM MF_MEDIA_ENGINE_ERR_ABORTED}
    MF_MEDIA_ENGINE_ERR_NETWORK           = 2,
    {$EXTERNALSYM MF_MEDIA_ENGINE_ERR_NETWORK}
    MF_MEDIA_ENGINE_ERR_DECODE            = 3,
    {$EXTERNALSYM MF_MEDIA_ENGINE_ERR_DECODE}
    MF_MEDIA_ENGINE_ERR_SRC_NOT_SUPPORTED = 4,
    {$EXTERNALSYM MF_MEDIA_ENGINE_ERR_SRC_NOT_SUPPORTED}
    MF_MEDIA_ENGINE_ERR_ENCRYPTED         = 5
    {$EXTERNALSYM MF_MEDIA_ENGINE_ERR_ENCRYPTED}
   );
...
const
  MF_MEDIA_ENGINE_FRAME_PROTECTION_FLAG_PROTECTED                              = DWord($01);
  {$EXTERNALSYM MF_MEDIA_ENGINE_FRAME_PROTECTION_FLAG_PROTECTED}
  MF_MEDIA_ENGINE_FRAME_PROTECTION_FLAG_REQUIRES_SURFACE_PROTECTION            = DWord($02);
  {$EXTERNALSYM MF_MEDIA_ENGINE_FRAME_PROTECTION_FLAG_REQUIRES_SURFACE_PROTECTION}
  MF_MEDIA_ENGINE_FRAME_PROTECTION_FLAG_REQUIRES_ANTI_SCREEN_SCRAPE_PROTECTION = DWord($04);
...
const
  MF_MEDIA_ENGINE_AUDIOONLY             = DWord($0001);
  {$EXTERNALSYM MF_MEDIA_ENGINE_AUDIOONLY}
  MF_MEDIA_ENGINE_WAITFORSTABLE_STATE   = DWord($0002);
  {$EXTERNALSYM MF_MEDIA_ENGINE_WAITFORSTABLE_STATE}
  MF_MEDIA_ENGINE_FORCEMUTE             = DWord($0004);
  {$EXTERNALSYM MF_MEDIA_ENGINE_FORCEMUTE}
  MF_MEDIA_ENGINE_REAL_TIME_MODE        = DWord($0008);  // sets the default real time mode, can be changed later by calling IMFMediaEngineEx::SetRealTimeMode
  {$EXTERNALSYM MF_MEDIA_ENGINE_REAL_TIME_MODE}
  MF_MEDIA_ENGINE_DISABLE_LOCAL_PLUGINS = DWord($0010);
  {$EXTERNALSYM MF_MEDIA_ENGINE_DISABLE_LOCAL_PLUGINS}
  MF_MEDIA_ENGINE_CREATEFLAGS_MASK      = DWord($001F);
...
const
  MF_MEDIA_ENGINE_ENABLE_PROTECTED_CONTENT = UINT32(1);
  {$EXTERNALSYM MF_MEDIA_ENGINE_ENABLE_PROTECTED_CONTENT}
  MF_MEDIA_ENGINE_USE_PMP_FOR_ALL_CONTENT  = UINT32(2);
  {$EXTERNALSYM MF_MEDIA_ENGINE_USE_PMP_FOR_ALL_CONTENT}
  MF_MEDIA_ENGINE_USE_UNPROTECTED_PMP      = UINT32(4);
...
type
  ...
  MF_MEDIA_ENGINE_EVENT                  = (
    ...
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_LOADSTART}
    MF_MEDIA_ENGINE_EVENT_PROGRESS           = 2,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_PROGRESS}
    MF_MEDIA_ENGINE_EVENT_SUSPEND            = 3,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_SUSPEND}
    MF_MEDIA_ENGINE_EVENT_ABORT              = 4,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_ABORT}
    MF_MEDIA_ENGINE_EVENT_ERROR              = 5,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_ERROR}
    MF_MEDIA_ENGINE_EVENT_EMPTIED            = 6,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_EMPTIED}
    MF_MEDIA_ENGINE_EVENT_STALLED            = 7,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_STALLED}
    MF_MEDIA_ENGINE_EVENT_PLAY               = 8,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_PLAY}
    MF_MEDIA_ENGINE_EVENT_PAUSE              = 9,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_PAUSE}
    MF_MEDIA_ENGINE_EVENT_LOADEDMETADATA     = 10,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_LOADEDMETADATA}
    MF_MEDIA_ENGINE_EVENT_LOADEDDATA         = 11,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_LOADEDDATA}
    MF_MEDIA_ENGINE_EVENT_WAITING            = 12,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_WAITING}
    MF_MEDIA_ENGINE_EVENT_PLAYING            = 13,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_PLAYING}
    MF_MEDIA_ENGINE_EVENT_CANPLAY            = 14,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_CANPLAY}
    MF_MEDIA_ENGINE_EVENT_CANPLAYTHROUGH     = 15,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_CANPLAYTHROUGH}
    MF_MEDIA_ENGINE_EVENT_SEEKING            = 16,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_SEEKING}
    MF_MEDIA_ENGINE_EVENT_SEEKED             = 17,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_SEEKED}
    MF_MEDIA_ENGINE_EVENT_TIMEUPDATE         = 18,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_TIMEUPDATE}
    MF_MEDIA_ENGINE_EVENT_ENDED              = 19,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_ENDED}
    MF_MEDIA_ENGINE_EVENT_RATECHANGE         = 20,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_RATECHANGE}
    MF_MEDIA_ENGINE_EVENT_DURATIONCHANGE     = 21,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_DURATIONCHANGE}
    MF_MEDIA_ENGINE_EVENT_VOLUMECHANGE       = 22,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_VOLUMECHANGE}
    //
    // Extensions
    //
    MF_MEDIA_ENGINE_EVENT_FORMATCHANGE       = 1000,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_FORMATCHANGE}
    MF_MEDIA_ENGINE_EVENT_PURGEQUEUEDEVENTS  = 1001,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_PURGEQUEUEDEVENTS}
    MF_MEDIA_ENGINE_EVENT_TIMELINE_MARKER    = 1002,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_TIMELINE_MARKER}
    MF_MEDIA_ENGINE_EVENT_BALANCECHANGE      = 1003,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_BALANCECHANGE}
    MF_MEDIA_ENGINE_EVENT_DOWNLOADCOMPLETE   = 1004,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_DOWNLOADCOMPLETE}
    MF_MEDIA_ENGINE_EVENT_BUFFERINGSTARTED   = 1005,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_BUFFERINGSTARTED}
    MF_MEDIA_ENGINE_EVENT_BUFFERINGENDED     = 1006,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_BUFFERINGENDED}
    MF_MEDIA_ENGINE_EVENT_FRAMESTEPCOMPLETED = 1007,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_FRAMESTEPCOMPLETED}
    MF_MEDIA_ENGINE_EVENT_NOTIFYSTABLESTATE  = 1008,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_NOTIFYSTABLESTATE}
    MF_MEDIA_ENGINE_EVENT_FIRSTFRAMEREADY    = 1009,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_FIRSTFRAMEREADY}
    MF_MEDIA_ENGINE_EVENT_TRACKSCHANGE       = 1010,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_TRACKSCHANGE}
    MF_MEDIA_ENGINE_EVENT_OPMINFO            = 1011,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_OPMINFO}
    MF_MEDIA_ENGINE_EVENT_RESOURCELOST       = 1012,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_RESOURCELOST}
    MF_MEDIA_ENGINE_EVENT_DELAYLOADEVENT_CHANGED  = 1013,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_DELAYLOADEVENT_CHANGED}
    MF_MEDIA_ENGINE_EVENT_STREAMRENDERINGERROR	  = 1014,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_STREAMRENDERINGERROR}
    MF_MEDIA_ENGINE_EVENT_SUPPORTEDRATES_CHANGED	= 1015,
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_SUPPORTEDRATES_CHANGED}
    MF_MEDIA_ENGINE_EVENT_AUDIOENDPOINTCHANGE     = 1016
    {$EXTERNALSYM MF_MEDIA_ENGINE_EVENT_AUDIOENDPOINTCHANGE}
  );
  ...
  MF_MEDIA_ENGINE_NETWORK             = (
    ...
    {$EXTERNALSYM MF_MEDIA_ENGINE_NETWORK_EMPTY}
    MF_MEDIA_ENGINE_NETWORK_IDLE      = 1,
    {$EXTERNALSYM MF_MEDIA_ENGINE_NETWORK_IDLE}
    MF_MEDIA_ENGINE_NETWORK_LOADING   = 2,
    {$EXTERNALSYM MF_MEDIA_ENGINE_NETWORK_LOADING}
    MF_MEDIA_ENGINE_NETWORK_NO_SOURCE = 3
    {$EXTERNALSYM MF_MEDIA_ENGINE_NETWORK_NO_SOURCE}
  );
  ...
  MF_MEDIA_ENGINE_READY                     = (
    ...
    {$EXTERNALSYM MF_MEDIA_ENGINE_READY_HAVE_NOTHING}
    MF_MEDIA_ENGINE_READY_HAVE_METADATA     = 1,
    {$EXTERNALSYM MF_MEDIA_ENGINE_READY_HAVE_METADATA}
    MF_MEDIA_ENGINE_READY_HAVE_CURRENT_DATA = 2,
    {$EXTERNALSYM MF_MEDIA_ENGINE_READY_HAVE_CURRENT_DATA}
    MF_MEDIA_ENGINE_READY_HAVE_FUTURE_DATA  = 3,
    {$EXTERNALSYM MF_MEDIA_ENGINE_READY_HAVE_FUTURE_DATA}
    MF_MEDIA_ENGINE_READY_HAVE_ENOUGH_DATA  = 4
    {$EXTERNALSYM MF_MEDIA_ENGINE_READY_HAVE_ENOUGH_DATA}
  );
  ...
  MF_MEDIA_ENGINE_CANPLAY                 = (
    ...
    {$EXTERNALSYM MF_MEDIA_ENGINE_CANPLAY_NOT_SUPPORTED}
    MF_MEDIA_ENGINE_CANPLAY_MAYBE         = 1,
    {$EXTERNALSYM MF_MEDIA_ENGINE_CANPLAY_MAYBE}
    MF_MEDIA_ENGINE_CANPLAY_PROBABLY      = 2);
    {$EXTERNALSYM MF_MEDIA_ENGINE_CANPLAY_PROBABLY}
  ...
  MF_MEDIA_ENGINE_PRELOAD             = (
    ...
    {$EXTERNALSYM MF_MEDIA_ENGINE_PRELOAD_MISSING}
    MF_MEDIA_ENGINE_PRELOAD_EMPTY     = 1,
    {$EXTERNALSYM MF_MEDIA_ENGINE_PRELOAD_EMPTY}
    MF_MEDIA_ENGINE_PRELOAD_NONE      = 2,
    {$EXTERNALSYM MF_MEDIA_ENGINE_PRELOAD_NONE}
    MF_MEDIA_ENGINE_PRELOAD_METADATA  = 3,
    {$EXTERNALSYM MF_MEDIA_ENGINE_PRELOAD_METADATA}
    MF_MEDIA_ENGINE_PRELOAD_AUTOMATIC = 4
    {$EXTERNALSYM MF_MEDIA_ENGINE_PRELOAD_AUTOMATIC}
  );
...
{$ENDIF}
  ...
  MF_MEDIA_ENGINE_S3D_PACKING_MODE                = (
    ...
    {$EXTERNALSYM MF_MEDIA_ENGINE_S3D_PACKING_MODE_NONE}
    MF_MEDIA_ENGINE_S3D_PACKING_MODE_SIDE_BY_SIDE = 1,
    {$EXTERNALSYM MF_MEDIA_ENGINE_S3D_PACKING_MODE_SIDE_BY_SIDE}
    MF_MEDIA_ENGINE_S3D_PACKING_MODE_TOP_BOTTOM   = 2
    {$EXTERNALSYM MF_MEDIA_ENGINE_S3D_PACKING_MODE_TOP_BOTTOM}
  );
  ...
  MF_MEDIA_ENGINE_STATISTIC                     = (
    ...
    {$EXTERNALSYM MF_MEDIA_ENGINE_STATISTIC_FRAMES_RENDERED}
    MF_MEDIA_ENGINE_STATISTIC_FRAMES_DROPPED    = 1,
    {$EXTERNALSYM MF_MEDIA_ENGINE_STATISTIC_FRAMES_DROPPED}
    MF_MEDIA_ENGINE_STATISTIC_BYTES_DOWNLOADED  = 2,
    {$EXTERNALSYM MF_MEDIA_ENGINE_STATISTIC_BYTES_DOWNLOADED}
    MF_MEDIA_ENGINE_STATISTIC_BUFFER_PROGRESS   = 3,
    {$EXTERNALSYM MF_MEDIA_ENGINE_STATISTIC_BUFFER_PROGRESS}
    MF_MEDIA_ENGINE_STATISTIC_FRAMES_PER_SECOND = 4,
    {$EXTERNALSYM MF_MEDIA_ENGINE_STATISTIC_FRAMES_PER_SECOND}
    MF_MEDIA_ENGINE_STATISTIC_PLAYBACK_JITTER   = 5,
    {$EXTERNALSYM MF_MEDIA_ENGINE_STATISTIC_PLAYBACK_JITTER}
    MF_MEDIA_ENGINE_STATISTIC_FRAMES_CORRUPTED  = 6,
    {$EXTERNALSYM MF_MEDIA_ENGINE_STATISTIC_FRAMES_CORRUPTED}
    MF_MEDIA_ENGINE_STATISTIC_TOTAL_FRAME_DELAY = 7
    {$EXTERNALSYM MF_MEDIA_ENGINE_STATISTIC_TOTAL_FRAME_DELAY}
  );
  ...
  MF_MEDIA_ENGINE_SEEK_MODE               = (
    ...
    {$EXTERNALSYM MF_MEDIA_ENGINE_SEEK_MODE_NORMAL}
    MF_MEDIA_ENGINE_SEEK_MODE_APPROXIMATE = 1
    {$EXTERNALSYM MF_MEDIA_ENGINE_SEEK_MODE_APPROXIMATE}
  );
  ...
  ['{83015ead-b1e6-40d0-a98a-37145ffe1ad1}']
    ...
    function GetStatistics(StatisticID: MF_MEDIA_ENGINE_STATISTIC;
                           out pStatistic: MfPROPVARIANT): HResult; stdcall;
  ...
  MF_MEDIA_ENGINE_EXTENSION_TYPE               = (
    ...
    {$EXTERNALSYM MF_MEDIA_ENGINE_EXTENSION_TYPE_MEDIASOURCE}
    MF_MEDIA_ENGINE_EXTENSION_TYPE_BYTESTREAM  = 1
    {$EXTERNALSYM MF_MEDIA_ENGINE_EXTENSION_TYPE_BYTESTREAM}
  );
  ...
  MF_MSE_VP9_SUPPORT_TYPE      = (
    ...
    {$EXTERNALSYM MF_MSE_VP9_SUPPORT_DEFAULT}
    MF_MSE_VP9_SUPPORT_ON      = 1,
    {$EXTERNALSYM MF_MSE_VP9_SUPPORT_ON}
    MF_MSE_VP9_SUPPORT_OFF     = 2
    {$EXTERNALSYM MF_MSE_VP9_SUPPORT_OFF}
  );
  ...
  MF_MSE_OPUS_SUPPORT_TYPE  = (
    ...
    {$EXTERNALSYM MF_MSE_OPUS_SUPPORT_ON}
    MF_MSE_OPUS_SUPPORT_OFF = 1
    {$EXTERNALSYM MF_MSE_OPUS_SUPPORT_OFF}
  );
...
// #if (WINVER >= _WIN32_WINNT_WINTHRESHOLD   (Win 8)
  ...
  MF_MSE_APPEND_MODE            = (
    ...
    {$EXTERNALSYM MF_MSE_APPEND_MODE_SEGMENTS}
    MF_MSE_APPEND_MODE_SEQUENCE = 1
    {$EXTERNALSYM MF_MSE_APPEND_MODE_SEQUENCE}
  );
  ...
  MF_MSE_READY          = (
    ...
    {$EXTERNALSYM MF_MSE_READY_CLOSED}
    MF_MSE_READY_OPEN   = 2,
    {$EXTERNALSYM MF_MSE_READY_OPEN}
    MF_MSE_READY_ENDED  = 3
    {$EXTERNALSYM MF_MSE_READY_ENDED}
  );
  ...
  MF_MSE_ERROR                 = (
    ...
    {$EXTERNALSYM MF_MSE_ERROR_NOERROR}
    MF_MSE_ERROR_NETWORK       = 1,
    {$EXTERNALSYM MF_MSE_ERROR_NETWORK}
    MF_MSE_ERROR_DECODE        = 2,
    {$EXTERNALSYM MF_MSE_ERROR_DECODE}
    MF_MSE_ERROR_UNKNOWN_ERROR = 3
    {$EXTERNALSYM MF_MSE_ERROR_UNKNOWN_ERROR}
  );
  ...
  _MF_MEDIA_ENGINE_KEYERR                = (
    ...
    {$EXTERNALSYM MF_MEDIAENGINE_KEYERR_UNKNOWN}
    MF_MEDIAENGINE_KEYERR_CLIENT         = 2,
    {$EXTERNALSYM MF_MEDIAENGINE_KEYERR_CLIENT}
    MF_MEDIAENGINE_KEYERR_SERVICE        = 3,
    {$EXTERNALSYM MF_MEDIAENGINE_KEYERR_SERVICE}
    MF_MEDIAENGINE_KEYERR_OUTPUT         = 4,
    {$EXTERNALSYM MF_MEDIAENGINE_KEYERR_OUTPUT}
    MF_MEDIAENGINE_KEYERR_HARDWARECHANGE = 5,
    {$EXTERNALSYM MF_MEDIAENGINE_KEYERR_HARDWARECHANGE}
    MF_MEDIAENGINE_KEYERR_DOMAIN         = 6
    {$EXTERNALSYM MF_MEDIAENGINE_KEYERR_DOMAIN}
  );
  ...
  _MF_HDCP_STATUS                           = (
    MF_HDCP_STATUS_ON                       = 0,
    {$EXTERNALSYM MF_HDCP_STATUS_ON}
    MF_HDCP_STATUS_OFF                      = 1,
    {$EXTERNALSYM MF_HDCP_STATUS_OFF}
    MF_HDCP_STATUS_ON_WITH_TYPE_ENFORCEMENT = 2
    {$EXTERNALSYM MF_HDCP_STATUS_ON_WITH_TYPE_ENFORCEMENT}
  );
  ...
  MF_MEDIA_ENGINE_OPM_STATUS                   = (
    ...
    {$EXTERNALSYM MF_MEDIA_ENGINE_OPM_NOT_REQUESTED}
    MF_MEDIA_ENGINE_OPM_ESTABLISHED            = 1,
    {$EXTERNALSYM MF_MEDIA_ENGINE_OPM_ESTABLISHED}
    MF_MEDIA_ENGINE_OPM_FAILED_VM              = 2,
    {$EXTERNALSYM MF_MEDIA_ENGINE_OPM_FAILED_VM}
    MF_MEDIA_ENGINE_OPM_FAILED_BDA             = 3,
    {$EXTERNALSYM MF_MEDIA_ENGINE_OPM_FAILED_BDA}
    MF_MEDIA_ENGINE_OPM_FAILED_UNSIGNED_DRIVER = 4,
    {$EXTERNALSYM MF_MEDIA_ENGINE_OPM_FAILED_UNSIGNED_DRIVER}
    MF_MEDIA_ENGINE_OPM_FAILED                 = 5
    {$EXTERNALSYM MF_MEDIA_ENGINE_OPM_FAILED}
  );
  ...
  MF_TIMED_TEXT_TRACK_KIND             = (
    ...
    {$EXTERNALSYM MF_TIMED_TEXT_TRACK_KIND_UNKNOWN}
    MF_TIMED_TEXT_TRACK_KIND_SUBTITLES = 1,
    {$EXTERNALSYM MF_TIMED_TEXT_TRACK_KIND_SUBTITLES}
    MF_TIMED_TEXT_TRACK_KIND_CAPTIONS  = 2,
    {$EXTERNALSYM MF_TIMED_TEXT_TRACK_KIND_CAPTIONS}
    MF_TIMED_TEXT_TRACK_KIND_METADATA  = 3
    {$EXTERNALSYM MF_TIMED_TEXT_TRACK_KIND_METADATA}
  );
  ...
  MF_TIMED_TEXT_UNIT_TYPE              = (
    ...
    {$EXTERNALSYM MF_TIMED_TEXT_UNIT_TYPE_PIXELS}
    MF_TIMED_TEXT_UNIT_TYPE_PERCENTAGE = 1
    {$EXTERNALSYM MF_TIMED_TEXT_UNIT_TYPE_PERCENTAGE}
  );
  ...
  MF_TIMED_TEXT_FONT_STYLE           = (
    ...
    {$EXTERNALSYM MF_TIMED_TEXT_FONT_STYLE_NORMAL}
    MF_TIMED_TEXT_FONT_STYLE_OBLIQUE = 1,
    {$EXTERNALSYM MF_TIMED_TEXT_FONT_STYLE_OBLIQUE}
    MF_TIMED_TEXT_FONT_STYLE_ITALIC  = 2
    {$EXTERNALSYM MF_TIMED_TEXT_FONT_STYLE_ITALIC}
  );
  ...
  MF_TIMED_TEXT_ALIGNMENT          = (
    ...
    {$EXTERNALSYM MF_TIMED_TEXT_ALIGNMENT_START}
    MF_TIMED_TEXT_ALIGNMENT_END    = 1,
    {$EXTERNALSYM MF_TIMED_TEXT_ALIGNMENT_END}
    MF_TIMED_TEXT_ALIGNMENT_CENTER = 2
    {$EXTERNALSYM MF_TIMED_TEXT_ALIGNMENT_CENTER}
  );
  ...
  MF_TIMED_TEXT_DISPLAY_ALIGNMENT          = (
    ...
    {$EXTERNALSYM MF_TIMED_TEXT_DISPLAY_ALIGNMENT_BEFORE}
    MF_TIMED_TEXT_DISPLAY_ALIGNMENT_AFTER  = 1,
    {$EXTERNALSYM MF_TIMED_TEXT_DISPLAY_ALIGNMENT_AFTER}
    MF_TIMED_TEXT_DISPLAY_ALIGNMENT_CENTER = 2
    {$EXTERNALSYM MF_TIMED_TEXT_DISPLAY_ALIGNMENT_CENTER}
  );
  ...
  MF_TIMED_TEXT_DECORATION                = (
    ...
    {$EXTERNALSYM MF_TIMED_TEXT_DECORATION_NONE}
    MF_TIMED_TEXT_DECORATION_UNDERLINE    = 1,
    {$EXTERNALSYM MF_TIMED_TEXT_DECORATION_UNDERLINE}
    MF_TIMED_TEXT_DECORATION_LINE_THROUGH = 2,
    {$EXTERNALSYM MF_TIMED_TEXT_DECORATION_LINE_THROUGH}
    MF_TIMED_TEXT_DECORATION_OVERLINE     = 4
    {$EXTERNALSYM MF_TIMED_TEXT_DECORATION_OVERLINE}
  );
  ...
  MF_TIMED_TEXT_WRITING_MODE        = (
    ...
    {$EXTERNALSYM MF_TIMED_TEXT_WRITING_MODE_LRTB}
    MF_TIMED_TEXT_WRITING_MODE_RLTB = 1,
    {$EXTERNALSYM MF_TIMED_TEXT_WRITING_MODE_RLTB}
    MF_TIMED_TEXT_WRITING_MODE_TBRL = 2,
    {$EXTERNALSYM MF_TIMED_TEXT_WRITING_MODE_TBRL}
    MF_TIMED_TEXT_WRITING_MODE_TBLR = 3,
    {$EXTERNALSYM MF_TIMED_TEXT_WRITING_MODE_TBLR}
    MF_TIMED_TEXT_WRITING_MODE_LR   = 4,
    {$EXTERNALSYM MF_TIMED_TEXT_WRITING_MODE_LR}
    MF_TIMED_TEXT_WRITING_MODE_RL   = 5,
    {$EXTERNALSYM MF_TIMED_TEXT_WRITING_MODE_RL}
    MF_TIMED_TEXT_WRITING_MODE_TB   = 6
    {$EXTERNALSYM MF_TIMED_TEXT_WRITING_MODE_TB}
  );
  ...
  MF_TIMED_TEXT_SCROLL_MODE           = (
    ...
    {$EXTERNALSYM MF_TIMED_TEXT_SCROLL_MODE_POP_ON}
    MF_TIMED_TEXT_SCROLL_MODE_ROLL_UP = 1
    {$EXTERNALSYM MF_TIMED_TEXT_SCROLL_MODE_ROLL_UP}
  );
  ...
  MF_TIMED_TEXT_CUE_EVENT = (
    ...
    {$EXTERNALSYM MF_TIMED_TEXT_CUE_EVENT_ACTIVE}
    MF_TIMED_TEXT_CUE_EVENT_INACTIVE, // Cue has become inactive
    {$EXTERNALSYM MF_TIMED_TEXT_CUE_EVENT_INACTIVE}
    MF_TIMED_TEXT_CUE_EVENT_CLEAR     // All cues has been deactivated
    {$EXTERNALSYM MF_TIMED_TEXT_CUE_EVENT_CLEAR}
  );
  ...
  MF_TIMED_TEXT_TRACK_READY_STATE = (
    ...
    {$EXTERNALSYM MF_TIMED_TEXT_TRACK_READY_STATE_NONE}
    MF_TIMED_TEXT_TRACK_READY_STATE_LOADING, // Track cues are being loaded.
    {$EXTERNALSYM MF_TIMED_TEXT_TRACK_READY_STATE_LOADING}
    MF_TIMED_TEXT_TRACK_READY_STATE_LOADED,  // Track cues are loaded and ready.
    {$EXTERNALSYM MF_TIMED_TEXT_TRACK_READY_STATE_LOADED}
    MF_TIMED_TEXT_TRACK_READY_STATE_ERROR    // Track error occurred.
    {$EXTERNALSYM MF_TIMED_TEXT_TRACK_READY_STATE_ERROR}
  );
...
//#if (WINVER >= _WIN32_WINNT_WINTHRESHOLD) (Win 8)
  ...
  MF_MEDIA_ENGINE_STREAMTYPE_FAILED           = (
    ...
    {$EXTERNALSYM MF_MEDIA_ENGINE_STREAMTYPE_FAILED_UNKNOWN}
    MF_MEDIA_ENGINE_STREAMTYPE_FAILED_AUDIO   = 1,
    {$EXTERNALSYM MF_MEDIA_ENGINE_STREAMTYPE_FAILED_AUDIO}
    MF_MEDIA_ENGINE_STREAMTYPE_FAILED_VIDEO   = 2
    {$EXTERNALSYM MF_MEDIA_ENGINE_STREAMTYPE_FAILED_VIDEO}
  );
...
//#endif // (WINVER >= _WIN32_WINNT_WINTHRESHOLD) (Win 8)
  ...
  MF_MEDIAKEYS_REQUIREMENT               = (
    ...
    {$EXTERNALSYM MF_MEDIAKEYS_REQUIREMENT_REQUIRED}
    MF_MEDIAKEYS_REQUIREMENT_OPTIONAL    = 2,
    {$EXTERNALSYM MF_MEDIAKEYS_REQUIREMENT_OPTIONAL}
    MF_MEDIAKEYS_REQUIREMENT_NOT_ALLOWED = 3
    {$EXTERNALSYM MF_MEDIAKEYS_REQUIREMENT_NOT_ALLOWED}
  );
