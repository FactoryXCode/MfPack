...
{$ENDIF}
  ...
  MF_MEDIA_ENGINE_FRAME_PROTECTION_FLAGS = (
    MF_MEDIA_ENGINE_FRAME_PROTECTION_FLAG_PROTECTED                              = $01,
    MF_MEDIA_ENGINE_FRAME_PROTECTION_FLAG_REQUIRES_SURFACE_PROTECTION            = $02,
    MF_MEDIA_ENGINE_FRAME_PROTECTION_FLAG_REQUIRES_ANTI_SCREEN_SCRAPE_PROTECTION = $04);
  ...
  ['{9f8021e8-9c8c-487e-bb5c-79aa4779938c}']
    ...
    function TransferVideoFrame(pDstSurf: IUnknown;
                                ...
                                pDst: TRECT;
                                pBorderClr: MFARGB;
                                out  pFrameProtectionFlags: DWORD): HResult; stdcall;
...
// #if (WINVER >= _WIN32_WINNT_WINTHRESHOLD   (Win 8)
  ...
  MF_MEDIA_ENGINE_CREATEFLAGS             = (
    MF_MEDIA_ENGINE_AUDIOONLY             = $0001,
    MF_MEDIA_ENGINE_WAITFORSTABLE_STATE   = $0002,
    MF_MEDIA_ENGINE_FORCEMUTE             = $0004,
    MF_MEDIA_ENGINE_REAL_TIME_MODE        = $0008,  // sets the default real time mode, can be changed later by calling IMFMediaEngineEx::SetRealTimeMode
    MF_MEDIA_ENGINE_DISABLE_LOCAL_PLUGINS = $0010,
    MF_MEDIA_ENGINE_CREATEFLAGS_MASK      = $001F
  );
