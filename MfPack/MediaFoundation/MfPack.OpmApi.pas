...
uses
  ...
  WinApi.Windows,
  {DirectX (Clootie)}
  MfPack.D3D9, {Use WinApi, MfPack or Clootie Dx}
  {MfPack}
  MfPack.MfpTypes,
  MfPack.DxVa2Api;
...
type
  ...
  _OPM_VIDEO_OUTPUT_SEMANTICS = (
    ...
    {$EXTERNALSYM OPM_VOS_COPP_SEMANTICS}
    OPM_VOS_OPM_SEMANTICS	        = 1,
    {$EXTERNALSYM OPM_VOS_OPM_SEMANTICS}
    OPM_VOS_OPM_INDIRECT_DISPLAY	= 2
    {$EXTERNALSYM OPM_VOS_OPM_INDIRECT_DISPLAY}
  );
...
const
  ...
  OPM_ACP_LEVEL_ONE   = ULONG(1);
  {$EXTERNALSYM OPM_ACP_LEVEL_ONE}
  OPM_ACP_LEVEL_TWO   = ULONG(2);
  {$EXTERNALSYM OPM_ACP_LEVEL_TWO}
  OPM_ACP_LEVEL_THREE = ULONG(3);
...
const
  OPM_ASPECT_RATIO_EN300294_FULL_FORMAT_4_BY_3                  = ULONG(0);
  OPM_ASPECT_RATIO_EN300294_BOX_14_BY_9_CENTER                  = ULONG(1);
  OPM_ASPECT_RATIO_EN300294_BOX_14_BY_9_TOP                     = ULONG(2);
  OPM_ASPECT_RATIO_EN300294_BOX_16_BY_9_CENTER                  = ULONG(3);
  OPM_ASPECT_RATIO_EN300294_BOX_16_BY_9_TOP                     = ULONG(4);
  OPM_ASPECT_RATIO_EN300294_BOX_GT_16_BY_9_CENTER               = ULONG(5);
  OPM_ASPECT_RATIO_EN300294_FULL_FORMAT_4_BY_3_PROTECTED_CENTER = ULONG(6);
  OPM_ASPECT_RATIO_EN300294_FULL_FORMAT_16_BY_9_ANAMORPHIC      = ULONG(7);
