...
const
  MF_RESOLUTION_MEDIASOURCE = DWord($1);
  {$EXTERNALSYM MF_RESOLUTION_MEDIASOURCE}
  MF_RESOLUTION_BYTESTREAM  = DWord($2);
  {$EXTERNALSYM MF_RESOLUTION_BYTESTREAM}
  MF_RESOLUTION_CONTENT_DOES_NOT_HAVE_TO_MATCH_EXTENSION_OR_MIME_TYPE  = DWord($10);
  {$EXTERNALSYM MF_RESOLUTION_CONTENT_DOES_NOT_HAVE_TO_MATCH_EXTENSION_OR_MIME_TYPE}
  MF_RESOLUTION_KEEP_BYTE_STREAM_ALIVE_ON_FAIL  = DWord($20);
  {$EXTERNALSYM MF_RESOLUTION_KEEP_BYTE_STREAM_ALIVE_ON_FAIL}
  MF_RESOLUTION_DISABLE_LOCAL_PLUGINS  = DWord($40);
  {$EXTERNALSYM MF_RESOLUTION_DISABLE_LOCAL_PLUGINS}
  MF_RESOLUTION_PLUGIN_CONTROL_POLICY_APPROVED_ONLY  = DWord($80);
  {$EXTERNALSYM MF_RESOLUTION_PLUGIN_CONTROL_POLICY_APPROVED_ONLY}
  MF_RESOLUTION_PLUGIN_CONTROL_POLICY_WEB_ONLY  = DWord($100);
  {$EXTERNALSYM MF_RESOLUTION_PLUGIN_CONTROL_POLICY_WEB_ONLY}
  MF_RESOLUTION_PLUGIN_CONTROL_POLICY_WEB_ONLY_EDGEMODE	= DWord($200);
  {$EXTERNALSYM MF_RESOLUTION_PLUGIN_CONTROL_POLICY_WEB_ONLY_EDGEMODE}
  MF_RESOLUTION_READ = DWord($10000);
  {$EXTERNALSYM MF_RESOLUTION_READ}
  MF_RESOLUTION_WRITE = DWord($20000);
...
type
  ...
  ['{90377834-21D0-4dee-8214-BA2E3E6C1127}']
    ...
    function Start(const pguidTimeFormat: TGUID;
                   const pvarStartPosition: MfPROPVARIANT): HResult; stdcall;
  ...
  MF_OBJECT_TYPE          = (
    ...
    {$EXTERNALSYM MF_OBJECT_MEDIASOURCE}
    MF_OBJECT_BYTESTREAM  = (MF_OBJECT_MEDIASOURCE + 1),
    {$EXTERNALSYM MF_OBJECT_BYTESTREAM}
    MF_OBJECT_INVALID     = (MF_OBJECT_BYTESTREAM + 1)
    {$EXTERNALSYM MF_OBJECT_INVALID}
  );
...
//#endif // (WINVER >= _WIN32_WINNT_WIN8)
  ...
  ['{0A97B3CF-8E7C-4a3d-8F8C-0C843DC247FB}']
    ...
    function PlaceMarker(const eMarkerType: MFSTREAMSINK_MARKER_TYPE;
                         const pvarMarkerValue: MfPROPVARIANT;
                         const pvarContextValue: MfPROPVARIANT): HResult; stdcall;
...
// (WINVER >= _WIN32_WINNT_WIN10)
  ...
  MFVideoSphericalProjectionMode             = (
    ...
    {$EXTERNALSYM MFVideoSphericalProjectionMode_Spherical}
    MFVideoSphericalProjectionMode_Flat      = (MFVideoSphericalProjectionMode_Spherical  + 1)
    {$EXTERNALSYM MFVideoSphericalProjectionMode_Flat}
  );
...
//#if (WINVER >= _WIN32_WINNT_WIN7)
  ...
  cwMFTOPOLOGY_DXVA_MODE    = (
    ...
    {$EXTERNALSYM MFTOPOLOGY_DXVA_DEFAULT}
    MFTOPOLOGY_DXVA_NONE    = 1,
    {$EXTERNALSYM MFTOPOLOGY_DXVA_NONE}
    MFTOPOLOGY_DXVA_FULL    = 2
    {$EXTERNALSYM MFTOPOLOGY_DXVA_FULL}
  );
  ...
  cwMFTOPOLOGY_HARDWARE_MODE = (
    ...
    {$EXTERNALSYM MFTOPOLOGY_HWMODE_SOFTWARE_ONLY}
    MFTOPOLOGY_HWMODE_USE_HARDWARE      = 1,
    {$EXTERNALSYM MFTOPOLOGY_HWMODE_USE_HARDWARE}
    MFTOPOLOGY_HWMODE_USE_ONLY_HARDWARE = 2
    {$EXTERNALSYM MFTOPOLOGY_HWMODE_USE_ONLY_HARDWARE}
  );
...
{$WARN BOUNDS_ERROR OFF}
  ...
  MF_TOPOLOGY_TYPE                = (
    ...
    {$EXTERNALSYM MF_TOPOLOGY_TRANSFORM_NODE}
    MF_TOPOLOGY_TEE_NODE          = (MF_TOPOLOGY_TRANSFORM_NODE + 1), // Tee node.
    {$EXTERNALSYM MF_TOPOLOGY_TEE_NODE}                               // A tee node does not hold a pointer to an object.
    ...
    MF_TOPOLOGY_MAX               = MAXDW // $ffffffff   Reserved.
    {$EXTERNALSYM MF_TOPOLOGY_MAX}
  );
...
{$WARN BOUNDS_ERROR ON}
  ...
  _MF_TOPONODE_FLUSH_MODE    = (
    ...
    {$EXTERNALSYM MF_TOPONODE_FLUSH_ALWAYS}
    MF_TOPONODE_FLUSH_SEEK   = (MF_TOPONODE_FLUSH_ALWAYS  + 1),
    {$EXTERNALSYM MF_TOPONODE_FLUSH_SEEK}
    MF_TOPONODE_FLUSH_NEVER  = (MF_TOPONODE_FLUSH_SEEK  + 1)
    {$EXTERNALSYM MF_TOPONODE_FLUSH_NEVER}
  );
  ...
  _MF_TOPONODE_DRAIN_MODE     = (
    ...
    {$EXTERNALSYM MF_TOPONODE_DRAIN_DEFAULT}
    MF_TOPONODE_DRAIN_ALWAYS  = (MF_TOPONODE_DRAIN_DEFAULT  + 1),
    {$EXTERNALSYM MF_TOPONODE_DRAIN_ALWAYS}
    MF_TOPONODE_DRAIN_NEVER   = (MF_TOPONODE_DRAIN_ALWAYS  + 1)
    {$EXTERNALSYM MF_TOPONODE_DRAIN_NEVER}
  );
  ...
  _MFSHUTDOWN_STATUS = (
    ...
    {$EXTERNALSYM MFSHUTDOWN_INITIATED}
    MFSHUTDOWN_COMPLETED  = ( MFSHUTDOWN_INITIATED + 1 )
    {$EXTERNALSYM MFSHUTDOWN_COMPLETED}
  );
  ...
  cwMF_URL_TRUST_STATUS = (
    ...
    {$EXTERNALSYM MF_LICENSE_URL_UNTRUSTED}
    MF_LICENSE_URL_TRUSTED = (MF_LICENSE_URL_UNTRUSTED + 1),
    {$EXTERNALSYM MF_LICENSE_URL_TRUSTED}
    MF_LICENSE_URL_TAMPERED = (MF_LICENSE_URL_TRUSTED + 1)
    {$EXTERNALSYM MF_LICENSE_URL_TAMPERED}
  );
  ...
  ['{F88CFB8C-EF16-4991-B450-CB8C69E51704}']
    ...
    function GetAllLanguages(out ppvLanguages: MfPROPVARIANT): HResult; stdcall;

    function SetProperty(const pwszName: LPCWSTR;
                         const ppvValue: MfPROPVARIANT): HResult; stdcall;

    function GetProperty(pwszName: LPCWSTR;
                         out ppvValue: MfPROPVARIANT): HResult; stdcall;

    function DeleteProperty(pwszName: LPCWSTR): HResult; stdcall;

    function GetAllPropertyNames(out ppvNames: MfPROPVARIANT): HResult; stdcall;
  ...
  _MFRATE_DIRECTION = (
    MFRATE_FORWARD = 0,
    {$EXTERNALSYM MFRATE_FORWARD}
    MFRATE_REVERSE = (MFRATE_FORWARD + 1)
    {$EXTERNALSYM MFRATE_REVERSE}
  );
...
//#if (WINVER >= _WIN32_WINNT_WIN7)
  ...
  ['{ab9d8661-f7e8-4ef4-9861-89f334f94e74}']
    ...
    function BeginConvertTimecodeToHNS(const pPropVarTimecode: MfPROPVARIANT;
                                       pCallback: IMFAsyncCallback;
                                       punkState: IUnknown): HResult; stdcall;
    ...
    function EndConvertHNSToTimecode(pResult: IMFAsyncResult;
                                     out pPropVarTimecode: MfPROPVARIANT): HResult; stdcall;
...
//#if (WINVER >= _WIN32_WINNT_WIN8)
  ...
  ['{26AFEA53-D9ED-42B5-AB80-E64F9EE34779}']
    ...
    function GetNearestKeyFrames(const pguidTimeFormat: TGUID;
                                 const pvarStartPosition: MfPROPVARIANT;
                                 out pvarPreviousKeyFrame: MfPROPVARIANT;
                                 out pvarNextKeyFrame: MfPROPVARIANT): HResult; stdcall;
...
//#endif (WINVER >= _WIN32_WINNT_WIN7)
  ...
  _MF_QUALITY_DROP_MODE = (
    MF_DROP_MODE_NONE = 0,
    {$EXTERNALSYM MF_DROP_MODE_NONE}
    MF_DROP_MODE_1    = $1,
    {$EXTERNALSYM MF_DROP_MODE_1}
    MF_DROP_MODE_2    = $2,
    {$EXTERNALSYM MF_DROP_MODE_2}
    MF_DROP_MODE_3    = $3,
    {$EXTERNALSYM MF_DROP_MODE_3}
    MF_DROP_MODE_4    = $4,
    {$EXTERNALSYM MF_DROP_MODE_4}
    MF_DROP_MODE_5    = $5,
    {$EXTERNALSYM MF_DROP_MODE_5}
    MF_NUM_DROP_MODES = $6
    {$EXTERNALSYM MF_NUM_DROP_MODES}
  );
  ...
  _MF_QUALITY_LEVEL           = (
    MF_QUALITY_NORMAL         = 0,
    {$EXTERNALSYM MF_QUALITY_NORMAL}
    MF_QUALITY_NORMAL_MINUS_1 = $1,
    {$EXTERNALSYM MF_QUALITY_NORMAL_MINUS_1}
    MF_QUALITY_NORMAL_MINUS_2 = $2,
    {$EXTERNALSYM MF_QUALITY_NORMAL_MINUS_2}
    MF_QUALITY_NORMAL_MINUS_3 = $3,
    {$EXTERNALSYM MF_QUALITY_NORMAL_MINUS_3}
    MF_QUALITY_NORMAL_MINUS_4 = $4,
    {$EXTERNALSYM MF_QUALITY_NORMAL_MINUS_4}
    MF_QUALITY_NORMAL_MINUS_5 = $5,
    {$EXTERNALSYM MF_QUALITY_NORMAL_MINUS_5}
    MF_NUM_QUALITY_LEVELS     = $6
    {$EXTERNALSYM MF_NUM_QUALITY_LEVELS}
  );
...
//#endif // (WINVER >= _WIN32_WINNT_WIN7)
  ...
  _MFNETSOURCE_PROTOCOL_TYPE = (
    ...
    {$EXTERNALSYM MFNETSOURCE_UNDEFINED}
    MFNETSOURCE_HTTP      = $1,
    {$EXTERNALSYM MFNETSOURCE_HTTP}
    MFNETSOURCE_RTSP      = $2,
    {$EXTERNALSYM MFNETSOURCE_RTSP}
    MFNETSOURCE_FILE      = $3,
    {$EXTERNALSYM MFNETSOURCE_FILE}
    MFNETSOURCE_MULTICAST = $4
    {$EXTERNALSYM MFNETSOURCE_MULTICAST}
  );
  ...
  _MFNET_PROXYSETTINGS         = (
    ...
    {$EXTERNALSYM MFNET_PROXYSETTING_NONE}
    MFNET_PROXYSETTING_MANUAL  = 1,
    {$EXTERNALSYM MFNET_PROXYSETTING_MANUAL}
    MFNET_PROXYSETTING_AUTO    = 2,
    {$EXTERNALSYM MFNET_PROXYSETTING_AUTO}
    MFNET_PROXYSETTING_BROWSER = 3
    {$EXTERNALSYM MFNET_PROXYSETTING_BROWSER}
  );
  ...
  _MFPOLICYMANAGER_ACTION = (
    PEACTION_NO        = 0,
    {$EXTERNALSYM PEACTION_NO}
    PEACTION_PLAY      = 1,
    {$EXTERNALSYM PEACTION_PLAY}
    PEACTION_COPY      = 2,
    {$EXTERNALSYM PEACTION_COPY}
    PEACTION_EXPORT    = 3,
    {$EXTERNALSYM PEACTION_EXPORT}
    PEACTION_EXTRACT   = 4,
    {$EXTERNALSYM PEACTION_EXTRACT}
    PEACTION_RESERVED1 = 5,
    {$EXTERNALSYM PEACTION_RESERVED1}
    PEACTION_RESERVED2 = 6,
    {$EXTERNALSYM PEACTION_RESERVED2}
    PEACTION_RESERVED3 = 7,
    {$EXTERNALSYM PEACTION_RESERVED3}
    PEACTION_LAST      = 7
    {$EXTERNALSYM PEACTION_LAST}
  );
  ...
  _MF_OPM_CGMSA_PROTECTION_LEVEL                 = (
    MF_OPM_CGMSA_OFF                             = 0,
    {$EXTERNALSYM MF_OPM_CGMSA_OFF}
    MF_OPM_CGMSA_COPY_FREELY                     = $1,
    {$EXTERNALSYM MF_OPM_CGMSA_COPY_FREELY}
    MF_OPM_CGMSA_COPY_NO_MORE                    = $2,
    {$EXTERNALSYM MF_OPM_CGMSA_COPY_NO_MORE}
    MF_OPM_CGMSA_COPY_ONE_GENERATION             = $3,
    {$EXTERNALSYM MF_OPM_CGMSA_COPY_ONE_GENERATION}
    MF_OPM_CGMSA_COPY_NEVER                      = $4,
    {$EXTERNALSYM MF_OPM_CGMSA_COPY_NEVER}
    MF_OPM_CGMSA_REDISTRIBUTION_CONTROL_REQUIRED = $8
    {$EXTERNALSYM MF_OPM_CGMSA_REDISTRIBUTION_CONTROL_REQUIRED}
  );
  ...
  _MF_OPM_ACP_PROTECTION_LEVEL = (
    MF_OPM_ACP_OFF         = 0,
    {$EXTERNALSYM MF_OPM_ACP_OFF}
    MF_OPM_ACP_LEVEL_ONE   = 1,
    {$EXTERNALSYM MF_OPM_ACP_LEVEL_ONE}
    MF_OPM_ACP_LEVEL_TWO   = 2,
    {$EXTERNALSYM MF_OPM_ACP_LEVEL_TWO}
    MF_OPM_ACP_LEVEL_THREE = 3,
    {$EXTERNALSYM MF_OPM_ACP_LEVEL_THREE}
    MF_OPM_ACP_FORCE_ULONG = $7FFFFFFF
    {$EXTERNALSYM MF_OPM_ACP_FORCE_ULONG}
  );
...
//#endif // (WINVER >= _WIN32_WINNT_WIN7)
  ...
  ['{A7E025DD-5303-4a62-89D6-E747E1EFAC73}']
    ...
    function GetStyles(out pPropVarStyleArray: MfPROPVARIANTArray): HResult; stdcall;
...
//#endif (WINVER >= _WIN32_WINNT_WIN7)
  ...
  _MF_TRANSCODE_TOPOLOGYMODE_FLAGS             = (
    ...
    {$EXTERNALSYM MF_TRANSCODE_TOPOLOGYMODE_SOFTWARE_ONLY}
    MF_TRANSCODE_TOPOLOGYMODE_HARDWARE_ALLOWED = 1
    {$EXTERNALSYM MF_TRANSCODE_TOPOLOGYMODE_HARDWARE_ALLOWED}
  );
  ...
  _MF_TRANSCODE_ADJUST_PROFILE_FLAGS                  = (
    ...
    {$EXTERNALSYM MF_TRANSCODE_ADJUST_PROFILE_DEFAULT}
    MF_TRANSCODE_ADJUST_PROFILE_USE_SOURCE_ATTRIBUTES = 1
    {$EXTERNALSYM MF_TRANSCODE_ADJUST_PROFILE_USE_SOURCE_ATTRIBUTES}
  );
  ...
  _MF_VIDEO_PROCESSOR_ALGORITHM_TYPE         = (
    ...
    {$EXTERNALSYM MF_VIDEO_PROCESSOR_ALGORITHM_DEFAULT}
    MF_VIDEO_PROCESSOR_ALGORITHM_MRF_CRF_444 = 1
    {$EXTERNALSYM MF_VIDEO_PROCESSOR_ALGORITHM_MRF_CRF_444}
  );
...
//#endif // (WINVER >= _WIN32_WINNT_WINBLUE)
  ...
  MF_MEDIAKEYSESSION_MESSAGETYPE                             = (
    ...
    {$EXTERNALSYM MF_MEDIAKEYSESSION_MESSAGETYPE_LICENSE_REQUEST}
    MF_MEDIAKEYSESSION_MESSAGETYPE_LICENSE_RENEWAL           = 1,
    {$EXTERNALSYM MF_MEDIAKEYSESSION_MESSAGETYPE_LICENSE_RENEWAL}
    MF_MEDIAKEYSESSION_MESSAGETYPE_LICENSE_RELEASE           = 2,
    {$EXTERNALSYM MF_MEDIAKEYSESSION_MESSAGETYPE_LICENSE_RELEASE}
    MF_MEDIAKEYSESSION_MESSAGETYPE_INDIVIDUALIZATION_REQUEST = 3
    {$EXTERNALSYM MF_MEDIAKEYSESSION_MESSAGETYPE_INDIVIDUALIZATION_REQUEST}
  );
  ...
  _MF_CROSS_ORIGIN_POLICY                  = (
    ...
    {$EXTERNALSYM MF_CROSS_ORIGIN_POLICY_NONE}
    MF_CROSS_ORIGIN_POLICY_ANONYMOUS       = 1,
    {$EXTERNALSYM MF_CROSS_ORIGIN_POLICY_ANONYMOUS}
    MF_CROSS_ORIGIN_POLICY_USE_CREDENTIALS = 2
    {$EXTERNALSYM MF_CROSS_ORIGIN_POLICY_USE_CREDENTIALS}
  );
...
//#if (WINVER >= _WIN32_WINNT_WINTHRESHOLD)
  ...
  _MFSensorStreamType = (
    ...
    {$EXTERNALSYM MFSensorStreamType_Unknown}
    MFSensorStreamType_Input   = (MFSensorStreamType_Unknown  + 1),
    {$EXTERNALSYM MFSensorStreamType_Input}
    MFSensorStreamType_Output  = (MFSensorStreamType_Input  + 1)
    {$EXTERNALSYM MFSensorStreamType_Output}
  );
  ...
  _MFSensorDeviceMode = (
    ...
    {$EXTERNALSYM MFSensorDeviceMode_Controller}
    MFSensorDeviceMode_Shared     = (MFSensorDeviceMode_Controller  + 1)
    {$EXTERNALSYM MFSensorDeviceMode_Shared}
  );
...
// WIN10 October 2018 update Redstone 5
  ...
  _MFCameraIntrinsic_DistortionModelType         = (
    ...
    {$EXTERNALSYM MFCameraIntrinsic_DistortionModelType_6KT}
    MFCameraIntrinsic_DistortionModelType_ArcTan = (MFCameraIntrinsic_DistortionModelType_6KT  + 1)
    {$EXTERNALSYM MFCameraIntrinsic_DistortionModelType_ArcTan}
  );
...
//////////////// FUNCTIONS /////////////////////////////////////////////////////
  ...
  function MFGetSupportedSchemes(out pPropVarSchemeArray: MfPROPVARIANT): HResult; stdcall;
  {$EXTERNALSYM MFGetSupportedSchemes}

  function MFGetSupportedMimeTypes(out pPropVarMimeTypeArray: MfPROPVARIANT): HResult; stdcall;
...
//#endif // (WINVER >= _WIN32_WINNT_WINBLUE)
  ...
  function MFCreateSequencerSegmentOffset(dwId: MFSequencerElementId;
                                          hnsOffset: MFTIME;
                                          out pvarSegmentOffset: MfPROPVARIANT): HResult; stdcall;
