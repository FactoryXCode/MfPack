...
type
  ...
  {$EXTERNALSYM IMMDevice}
	...
	['{D666063F-1587-4E43-81F1-B948E807363F}']
		...
		function Activate(const iid: REFIID;
                      dwClsCtx: DWORD;
                      {In_opt} pActivationParams: PMfPROPVARIANT;
                      out ppInterface): HRESULT; stdcall;  // Replaced IUNKOWN to pointer to a pointer, as described on msdn:
                                                           // https://msdn.microsoft.com/nl-nl/library/windows/desktop/dd371405
  ...
  {$EXTERNALSYM IMMDeviceActivator}
	...
	['{3B0D0EA4-D0A9-4B0E-935B-09516746FAC0}']
		function Activate(const iid: REFIID;
                      const pDevice: IMMDevice;
                      {opt} pActivationParams: PMfPROPVARIANT;
  ...
  function ActivateAudioInterfaceAsync(deviceInterfacePath: LPCWSTR;
                                       const riid: REFIID;
                                       {opt} activationParams: PMfPROPVARIANT;
