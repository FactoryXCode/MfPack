...
// Module: MfPack.SpatialAudioClient.pas
...
//==============================================================================
unit MfPack.SpatialAudioClient;
...
type
  ...
  ['{BBF8E066-AAAA-49BE-9A4D-FD2A858EA27F}']
    ...
    function IsSpatialAudioStreamAvailable(const streamUuid: REFIID;
                                           auxiliaryInfo: MfPROPVARIANT): HRESULT; stdcall;
    ...
    //
    function ActivateSpatialAudioStream(activationParams: MfPROPVARIANT;  // activation parameters for the required streams for example SpatialAudioObjectRenderStreamForMetadataActivationParams
