...
function TFileCaptureAsync.ConfigureSourceReader(const AAttributes: IMFAttributes) : Boolean;
begin
...
begin
  ...
  try
    ...
    begin
      ...
      else if not Assigned(pSample) and (FramesSkipped < MaxFramesToSkip) then
      begin
        ReadNextSample;
        HandleFrameSkipped;
      end
