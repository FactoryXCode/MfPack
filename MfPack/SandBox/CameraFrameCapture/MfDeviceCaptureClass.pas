...
type
  ...
  TCaptureFormat = _TCaptureFormat;
  TCaptureFormatArray = array of TCaptureFormat;
...
try
  ...
  hr := pSourcePD.GetStreamDescriptorCount(dStreamCount);
...
function TMfCaptureEngine.GetVideoDisplay: IMFVideoDisplayControl;
begin
  Result := m_pVideoDisplay;
end;
